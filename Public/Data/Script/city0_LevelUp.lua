...
x805020_g_Name	="Bang Hµi ĞÕi T±ng Quän"
...
x805020_g_MissionTarget="Cho ğÕi t±ng quän bang hµi 5 ğ°ng ti«n"

x805020_g_MissionContinue="Các hÕ ğã có ğü 5 ğ°ng ti«n chßa?"

x805020_g_MissionComplete="  », làm khá l¡m. Xem ra các hÕ có nhi«u ti«n l¡m ğ¤y"

x805020_g_MoneyBonus=0

x805020_g_SignPost = {x = 109, z = 167, tip = "Bang Hµi ĞÕi T±ng Quän"}
...
function x805020_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x805020_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		if ret > 0 then
			...
			Msg2Player(  sceneId, selfId,"#YÍê³ÉÈÎ„Õ£ºÉı¼‰½¨ºB",MSG2PLAYER_PARA )
