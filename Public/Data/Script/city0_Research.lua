...
x805026_g_MissionTarget="Cho Bang Hµi ÐÕi T±ng Quän 5 ð°ng ti«n"
...
function x805026_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø: thång c¤p nghiên cÑu",MSG2PLAYER_PARA )
...
function x805026_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x805026_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
			...
			if ret > 0 then
				...
				Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø: thång c¤p nghiên cÑu",MSG2PLAYER_PARA )
