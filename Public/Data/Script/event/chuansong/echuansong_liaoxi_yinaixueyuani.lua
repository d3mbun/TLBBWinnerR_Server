...
function x400925_OnEnterArea( sceneId, selfId )
		...
		UICommand_AddString(sceneId, "Ngân Ngai Tuyªt Nguyên là khu vñc không tång sát khí, c¥n chú ý ðªn sñ an toàn. Các hÕ xác nh§n không?");
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x400925_GotoYinaixueyuan( sceneId, selfId, targetId )	--µã»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
