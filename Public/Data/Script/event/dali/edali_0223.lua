...
x210223_g_MissionTarget="    V« #GNgû Hoa Ğàn thành ĞÕi Lı#W tìm ğªn #GTri®u Thiên Sß #W#{_INFOAIM160,157,2, Tri®u Thiên Sß}. "
x210223_g_MissionComplete="  Càng ngày nhi«u ngß¶i tr· thành bÕn hæu cüa các hÕ. H÷ ğ«u ğánh giá r¤t cao v« các hÕ. Ta ğã thay m£t TÑ ĞÕi Thi®n Nhân, viªt thêm cho các hÕ #Ymµt lá thß gi¾i thi®u #W"
x210223_g_MoneyBonus=24
x210223_g_SignPost = {x = 282, z = 254, tip = "Tri®u Thiên Sß"}
x210223_g_ItemBonus={{id=40002108,num=1}}

x210223_g_Custom	= { {id="Ğã tìm th¤y Tri®u Thiên Sß",num=1} }
x210223_g_IsMissionOkFail = 1		--±äÁ¿toÕ ğµ µÚ0Î»
...
function x210223_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø#W: Lá thß gi¾i thi®u thÑ 7",MSG2PLAYER_PARA )
		...
		--Ìí¼ÓÈÎÎñ½±Àø
			if ret > 0 then
				...
				if ret > 0 then
					...
					Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: Lá thß gi¾i thi®u thÑ 7",MSG2PLAYER_PARA )
				end
			else
				--ÈÎÎñ½±ÀøÃ»ÓĞ¼Ó³É¹¦
				BeginEvent(sceneId)
