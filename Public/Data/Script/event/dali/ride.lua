...
x210299_g_rideskillList[1] ={limitLevel = 40, costMoney =350000, skillList = {
	...
	--{id=470,name="KÜ thu§t: Linh Dß½ng"}}
	}};
...
x210299_g_rideskillList[2] ={limitLevel = 60, costMoney =2900000, skillList = {
	...
	--{id=471,name="KÜ thu§t: Tuyªt Linh Dß½ng"}}
	}};
	
x210299_g_rideskillList[3] ={limitLevel = 80, costMoney =10000000, skillList = {
	{id=1087,name="KÜ Thu§t: Nhß Ý H±"},
	{id=1086,name="KÜ Thu§t: Li®t Di­m Sß"},
	{id=1085,name="KÜ Thu§t: Ngân Nguy®t Lang"},
	{id=1090,name="KÜ Thu§t: ThuÜ Liên HÕc"},
	{id=1084,name="KÜ Thu§t: Lßu Ly Phøng"},
	{id=1092,name="KÜ Thu§t: Thanh Ly Ngßu"},
	{id=1088,name="KÜ Thu§t: Long Huyªt Mã"},
	{id=1089,name="KÜ Thu§t: Vø Änh Ðiêu"},
	{id=1091,name="KÜ Thu§t: Th¤t Thái Lµc"},
	--{id=471,name="KÜ thu§t: Tuyªt Linh Dß½ng"}}
	}};
