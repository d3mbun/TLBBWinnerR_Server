...
x050030_g_StartDayTime	= 8036		--»î¶¯¿ªÊ¼(Ê×²¥)Ê±¼ä 2008-2-6
x050030_g_EndDayTime		= 8042		--»î¶¯½áÊøÊ±¼ä 2008-2-12
...
x050030_g_FireShowTbl = {
	...
	[6]  = { {x=160,y=105,id=8},{x=160,y=105,id=17} },
	[5]  = { {x=160,y=105,id=1},{x=160,y=105,id=5} },
	[4]  = { {x=160,y=105,id=7},{x=160,y=105,id=13},{x=160,y=105,id=6},{x=160,y=105,id=7} },
	[3]  = { {x=150,y=114,id=9},{x=150,y=97,id=9},{x=169,y=97,id=9},{x=169,y=114,id=9},{x=160,y=105,id=15} },
...
x050030_g_BOSSTbl = {
	...
	--ËïÃÀÃÀ....
	["SunMeiMei"] 		= { dateId = 3891, createMsg = "Không" },
	...
	["YingYing"] 			= { dateId = 3928, createMsg = "Không" },
	["ZhuZhu"]				= { dateId = 3926, createMsg = "Không" },
	["FeiTianMao"]		= { dateId = 3916, createMsg = "#{SpringFestiva2007_BOSS_13}" },
	["GouGou"]				= { dateId = 3927, createMsg = "Không" },
	["HuHu"]					= { dateId = 3929, createMsg = "Không" },
...
function x050030_CreateBossActor( sceneId, strName, posX, posY, notify )
	...
	if notify and notify == 1 and notify2 == 1 then
		local msg = "#P[Xuân vãn ngß¶i chü trì - Tôn Mî Mî].#W"..bossData.createMsg
