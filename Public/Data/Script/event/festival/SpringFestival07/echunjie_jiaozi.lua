...
--»î¶¯Ê±¼ä
x050056_g_StartDayTime = 20090119   --»î¶¯½áÊøÊ±¼ä 2009/01/19
x050056_g_EndDayTime = 20090204   --»î¶¯½áÊøÊ±¼ä 2009/02/04
...
x050056_g_strCannotToday4b = "Lînh quà th¥y trò #c00ff00 Thiên chi giáo tØ #W l­ bao"
...
function x050056_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if NumText == 101 then
		...
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x050056_g_ScriptId, "Ta mu¯n lînh", 6, 201 )
			AddNumText(sceneId, x050056_g_ScriptId, "Lînh phu thê", 6, 202 )
			AddNumText(sceneId, x050056_g_ScriptId, "Lînh kªt bái", 6, 203 )
			AddNumText(sceneId, x050056_g_ScriptId, "Lînh th¥y trò", 6, 204 )
...
function x050056_OnEnumerate( sceneId, selfId, targetId )
    ...
    if 1 == isTime then
			...
			AddNumText(sceneId, x050056_g_ScriptId, "V« Thiên chi giáo tØ", 11, 205 )												
    end
...
function x050056_GivePlayerJiaoZi( sceneId, selfId )
		...
		--if ret < 1  then
		--	BeginEvent(sceneId)
		--		AddText( sceneId, "Tay nãy ð¥y", 0 )
		--	EndEvent(sceneId)
		--	DispatchMissionTips(sceneId,selfId)
		--else
		--	AddItemListToHuman(sceneId,selfId)
		--	BeginEvent(sceneId)
		--	AddText( sceneId, "Nh§n ðßþc Bí tô thanh phong", 0 )
		--EndEvent(sceneId)
		--	DispatchMissionTips(sceneId,selfId)
		--end
