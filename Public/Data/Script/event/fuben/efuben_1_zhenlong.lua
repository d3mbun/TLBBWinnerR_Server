...
x401000_g_MissionTarget="Giªt hªt toàn bµ quái v§t"	--Møc tiêu nhi®m vø
x401000_g_ContinueInfo="Các hÕ phäi tiªp tøc c¯ g¡ng nhé!"	--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x401000_g_MissionComplete="Cám ½n, chúng tôi cu¯i cùng cûng ğã dám ra khöi cØa r°i"	--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x401000_g_Param_huan		=0	--0ºÅ: ÒÑ¾­Íê³ÉtoÕ ğµ »·Êı,TÕi ½ÓÊÕÈÎÎñÊ±ºò¸³Öµ
x401000_g_Param_ok			=1	--1ºÅ: µ±Ç°ÈÎÎñĞúng·ñÍê³É(0Î´Íê³É£»1Íê³É)
x401000_g_Param_sceneid		=2	--2ºÅ: µ±Ç°¸±±¾ÈÎÎñtoÕ ğµ ³¡¾°ºÅ
x401000_g_Param_teamid		=3	--3ºÅ: ½Ó¸±±¾ÈÎÎñÊ±ºòtoÕ ğµ ¶ÓÎéºÅ
x401000_g_Param_killcount	=4	--4ºÅ: É±ËÀÈÎÎñ¹ÖtoÕ ğµ ÊıÁ¿
x401000_g_Param_time		=5	--5ºÅ: Íê³É¸±±¾ËùÓÃÊ±¼ä(µ¥Î»:  giây)
--6ºÅ: Î´ÓÃ
--7ºÅ: Î´ÓÃ

x401000_g_CopySceneType=FUBEN_EXAMPLE	--¸±±¾ÀàĞÍ,¶¨ÒåTÕi ScriptGlobal.luaÀïÃæ
x401000_g_LimitMembers=1			--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
x401000_g_TickTime=5				--»Øµ÷½Å±¾toÕ ğµ Ê±ÖÓÊ±¼ä(µ¥Î»:  giây/´Î)
x401000_g_LimitTotalHoldTime=360	--¸±±¾¿ÉÒÔ´æ»îtoÕ ğµ Ê±¼ä(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÔòÈÎÎñ½«»áth¤t bÕi
x401000_g_LimitTimeSuccess=500		--¸±±¾Ê±¼äÏŞÖÆ(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÈÎÎñÍê³É
x401000_g_CloseTick=6				--¸±±¾¹Ø±ÕÇ°µ¹¼ÆÊ±(µ¥Î»: ´ÎÊı)
x401000_g_NoUserTime=300			--¸±±¾ÖĞÃ»ÓĞÈËºó¿ÉÒÔ¼ÌĞø±£´ætoÕ ğµ Ê±¼ä(µ¥Î»:  giây)
x401000_g_DeadTrans=1				--ËÀÍö×ªÒÆÄ£Ê½,0: ËÀÍöºó»¹¿ÉÒÔ¼ÌĞøTÕi ¸±±¾,1: ËÀÍöºó±»Ç¿ÖÆÒÆ³ö¸±±¾
x401000_g_Fuben_X=64				--½øÈë¸±±¾toÕ ğµ Î»ÖÃX
x401000_g_Fuben_Z=64				--½øÈë¸±±¾toÕ ğµ Î»ÖÃZ
x401000_g_Back_X=234				--Ô´³¡¾°Î»ÖÃX
x401000_g_Back_Z=69					--Ô´³¡¾°Î»ÖÃZ
x401000_g_TotalNeedKill=10			--C¥n É±ËÀ¹ÖÎïÊıÁ¿

x401000_g_StartTick=5 --¿ªÊ¼³ö¹ÖtoÕ ğµ Ê±¼ä
x401000_g_A_B=7000	--ÓÉ²»¿É¹¥»÷×´Ì¬±ä³É¿É¹¥»÷×´Ì¬toÕ ğµ Ê±¼ä(µ¥Î»: ºÁ giây)
x401000_g_B_C=15000	--ÓÉ¿É¹¥»÷×´Ì¬±ä³ÉÈËĞÎ¹ÖÎïtoÕ ğµ Ê±¼ä(µ¥Î»: ºÁ giây)
...
x401000_g_mListCount=1 --¿ÉÒÔÓÃÓÚÑ¡ÔñtoÕ ğµ ÆåÆ×ÊıÁ¿
x401000_g_mListSize=100 --Ã¿cáiÆåÆ×ÓµÓĞtoÕ ğµ ²½Êı
--ÆåÆ×Êı¾İ
...
function x401000_OnDefaultEvent( sceneId, selfId, targetId )
	if( IsHaveMission(sceneId,selfId,x401000_g_MissionId) > 0)  then	--Èç¹ûÍæ¼ÒÒÑ¾­½ÓÁËCái này ÈÎÎñ
    ...
    elseif x401000_CheckAccept(sceneId,selfId) > 0 then		--Ã»ÓĞÈÎÎñ,Thöa mãnÈÎÎñ½ÓÊÕÌõ¼ş
...
function x401000_OnAccept( sceneId, selfId )
	...
	if( IsHaveMission(sceneId,selfId,x401000_g_MissionId) > 0)  then	--ÒÑ¾­ÓĞÈÎÎñtoÕ ğµ 
		misIndex = GetMissionIndexByID(sceneId,selfId,x401000_g_MissionId)
...
function x401000_MakeCopyScene( sceneId, selfId, nearmembercount )
	...
	LuaFnSetCopySceneData_Param(sceneId, 0, x401000_g_CopySceneType);--ÉèÖÃ¸±±¾Êı¾İ,ÕâÀï½«0ºÅË÷ÒıtoÕ ğµ Êı¾İÉèÖÃÎª999,ÓÃÓÚ±íÊ¾¸±±¾ºÅ999(Êı×Ö×Ô¶¨Òå)
	...
	LuaFnSetCopySceneData_Param(sceneId, 7, 0) ;--É±ËÀ¹ÖtoÕ ğµ ÊıÁ¿
	LuaFnSetCopySceneData_Param(sceneId, 8, random(1,x401000_g_mListCount)) ;--Ñ¡ÓÃtoÕ ğµ ÆåÆ×
	LuaFnSetCopySceneData_Param(sceneId, 9, 0) ;--ÒÑ¾­ÏÂÁËtoÕ ğµ ²½Êı

	
	if	mylevel<=10	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 1) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=15	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 2) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=20	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 3) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=25	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 4) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=30	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 5) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=35	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 6) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=40	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 7) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=45	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 8) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	elseif	mylevel<=50	 then
		LuaFnSetCopySceneData_Param(sceneId,10, 9) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
	end	
...
function x401000_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x401000_CheckSubmit( sceneId, selfId, selectRadioId )>0 then		--ÒÑ¾­Hoàn t¤t nhi®m vøÁË
	
		local	iHuan=GetMissionData(sceneId,selfId,MD_LINGLONG_HUAN)	--È¡ ği¬m×Ü¹²×ö¹ıtoÕ ğµ »·Êı
		iHuan=iHuan+1
		local iDayCount=GetMissionData(sceneId,selfId,MD_LINGLONG_DAYCOUNT)
		local iDayTime = mod(iDayCount,100000)	--ÉÏmµt ´Î½»ÈÎÎñtoÕ ğµ Ê±¼ä
		local iDayHuan = floor(iDayCount/100000) --µ±ÌìÄÚÍê³ÉtoÕ ğµ ÈÎÎñ»·Êı
...
function x401000_OnKillObject( sceneId, selfId, objdataId ,objId )
	...
	if killednumber<x401000_g_TotalNeedKill then
		...
		BeginEvent(sceneId)
			strText = format("Ğã giªt %d/%d", killednumber, x401000_g_TotalNeedKill )
			AddText(sceneId,strText);
		EndEvent(sceneId)
		...
		for i=0,num-1 do
			...
			misIndex = GetMissionIndexByID(sceneId,humanObjId,x401000_g_MissionId) --È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
			local killedcount = GetMissionParam( sceneId, humanObjId, misIndex, x401000_g_Param_killcount) --È¡ ği¬mÒÑ¾­É±ÁËtoÕ ğµ ¹ÖÎïÊı
...
function x401000_OnHumanDie( sceneId, selfId, killerId )
	if x401000_g_DeadTrans==1 then --ËÀÍöºóC¥n ±»Ç¿ÖÆÌß³ö³¡¾°
	
		misIndex = GetMissionIndexByID(sceneId,selfId,x401000_g_MissionId)--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
...
function x401000_OnCopySceneTimer( sceneId, nowTime )
	...
	elseif TickCount == x401000_g_LimitTimeSuccess then
		...
		for	i=0,membercount-1 do
			...
			misIndex = GetMissionIndexByID(sceneId,mems[i],x401000_g_MissionId)--È¡ ği¬mÈÎÎñÊı¾İË÷ÒıÖµ
			--½«ÈÎÎñtoÕ ğµ µÚ1ºÅÊı¾İÉèÖÃÎª1,±íÊ¾Íê³ÉtoÕ ğµ ÈÎÎñ
	...
	elseif TickCount == x401000_g_LimitTotalHoldTime then --¸±±¾×ÜÊ±¼äÏŞÖÆµ½ÁË
		...
		for	i=0,membercount-1 do
			mems[i] = LuaFnGetCopyScene_HumanObjId(sceneId,i)
			DelMission( sceneId, mems[i], x401000_g_MissionId );--ÈÎÎñth¤t bÕi,É¾³ıÖ®
			if LuaFnIsObjValid(sceneId, mems[i]) == 1 and LuaFnIsCanDoScriptLogic(sceneId, mems[i]) == 1 then
  			BeginEvent(sceneId)
		...
		if TickCount>=x401000_g_StartTick and membercount>0 then --Ê±¼äµ½,¿ªÊ¼³ö¹Ö
			...
			mgroup = LuaFnGetCopySceneData_Param(sceneId,10) ;--¼ÇÂ¼Ëù²úÉútoÕ ğµ ¹ÖÎï×é
			...
			for i=0, monstercount-1 do
				...
				if LuaFnIsCharacterLiving(sceneId, monsterobjid)>0 then --»îtoÕ ğµ ¹ÖÎï
					...
					if monstertype==x401000_g_Black_A[mgroup] then
						if nowTime>=mcreatetime+x401000_g_A_B then --C¥n ½«¹ÖÎï±ä³ÉB×´Ì¬ÁË
					...
					elseif monstertype==x401000_g_Black_B[mgroup] then
						if nowTime>=mcreatetime+x401000_g_A_B+x401000_g_B_C then --C¥n ½«¹ÖÎï±ä³ÉC×´Ì¬ÁË
							LuaFnDeleteMonster(sceneId, monsterobjid)
			...
			QiPu = LuaFnGetCopySceneData_Param(sceneId, 8) ;--È¡ ği¬mÆåÆ×
			PressStep = LuaFnGetCopySceneData_Param(sceneId, 9) ;--È¡ ği¬mÒÑ¾­ÏÂÁËtoÕ ğµ ²½Êı
			if PressStep<x401000_g_mListSize then
				...
				mobjid = 0
				if PressStep==x401000_g_mListSize then --×îºómµt cáiË¢toÕ ğµ ÌØÊâ¹ÖÎï
