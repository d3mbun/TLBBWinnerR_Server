...
function x401001_CheckAndEnterScene(sceneId, selfId, targetId, eventId)
	...
	strOutmsg = "Tham gia hoÕt ðµng ch½i c¶ c¥n có "..x401001_g_limitMembers.." Ngß¶i ho£c Ðµi có "..x401001_g_limitMembers.." Ngß¶i tr· lên m¾i có th¬ tham gia. Nhóm cüa các hÕ không ðü ngß¶i";
