...
x889051_gGongGaoInfo ={
  ...
  "#{_INFOUSR%s}#cff99cc Ğem 5 cái Niên thú bính ğ° giao cho #GLÕc Dß½ng tiêu sß (81,117)#YGiä Uy Tín#cff99cc, mµt cái #{_INFOMSG%s}#cff99cc thoát phá hß không mà ğªn.",
}
