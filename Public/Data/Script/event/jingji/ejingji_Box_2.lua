...
x125023_g_SmallBoxBuff = {
				{id=1,name="Tÿ S°c BÌ C§p",buff=8053},
				{id=2,name="Ho‡ng S°c BÌ C§p",buff=8052},
				{id=3,name="L¯c S°c BÌ C§p",buff=8051},
				{id=4,name="B’ch S°c BÌ C§p",buff=8050},
				{id=5,name="H°c S°c BÌ C§p",buff=8049},
				{id=6,name="Lam S°c BÌ C§p",buff=8048},
				{id=7,name="H∞ng S°c BÌ C§p",buff=8047},
}
