...
x200035_g_MissionComplete="  Ra khöi? Không th¬ nào! TÕi hÕ không ği ğßşc næa, lúc tÕi hÕ và nghîa huynh kªt bái kim lang, và ğã th« r¢ng, có phúc cùng hß·ng, có h÷a cùng chia, trong lúc nguy c¤p th¤y h÷a không giúp, Ki«u Phong tôi ğây nh¤t quyªt không làm. "	--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
function x200035_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if( IsHaveMission(sceneId,selfId,x200035_g_MissionId) > 0)  then
		...
		Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: TÑ Di®n S· Ca",MSG2PLAYER_PARA )
