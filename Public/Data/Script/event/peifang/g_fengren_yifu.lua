...
function x700960_AbilityProduce( sceneId, selfId, recipeId )
	...
	for i = 1, tblCount do
		...
		--TÕi ÕâÀï¹ã²¥
		BroadMsgByChatPipe( sceneId, selfId, "#{_INFOUSR"..GetName( sceneId, selfId).."}#IÊÖÖ¯³É¼ë,·Ä¶ÏËóËé,ÖÕÓÚÖ¯Ôì³ömµt ¼þÈçÃÎÈç»Ã,½õÖ¯²Ê·ÄtoÕ ðµ #{_INFOMSG"..itemInfo.."}#I,¿à¾¡¸ÊÀ´,²»½ûÐ¦ÑÕÖð¿ª.", 4);
	end	
