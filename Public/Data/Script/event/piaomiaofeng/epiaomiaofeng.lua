...
x402263_g_CopySceneType = FUBEN_PIAOMIAOFENG	--¸±±¾ÀàÐÍ£¬¶¨ÒåÔÚScriptGlobal.luaÀïÃæ

x402263_g_TickTime		= 1				--»Øµ÷½Å±¾µÄÊ±ÖÓÊ±¼ä£¨µ¥Î»£ºÃë/´Î£©
x402263_g_NoUserTime	= 300			--¸±±¾ÖÐÃ»ÓÐÈËºó¿ÉÒÔ¼ÌÐø±£´æµÄÊ±¼ä£¨µ¥Î»£ºÃë£©
...
function x402263_TickFubenLife( sceneId, nowTime )
	...
	if lifeStep == 14 then
		...
		x402263_TipAllHuman( sceneId, "Các hÕ s¨ r¶i khöi n½i này trong vòng 1 giây næa" )
		return
	end
