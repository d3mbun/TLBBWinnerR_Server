...
--buff....
x402277_Buff_MianYi1	= 10472	--免疫一些负面效果....
...
--AI Index....
x402277_IDX_CombatTime		= 1	--进入战斗的计时器....用于记录已经进入战斗多长时间了....
x402277_IDX_UseSkillIndex	= 2	--接下来该使用技能表中的第几个技能....

x402277_IDX_CombatFlag 			= 1	--是否处于战斗状态的标志....
x402277_IDX_IsKuangBaoMode	= 2	--是否处于狂暴模式的标志....
...
function x402277_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#{XPM_8724_1}#{_INFOUSR%s}#{XPM_8724_2}", playerName); --哈大霸
