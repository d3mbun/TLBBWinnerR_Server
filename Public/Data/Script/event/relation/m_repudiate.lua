...
x806004_g_Repudiate["Name"]		= "CßŞng bÑc ly hôn"
...
function x806004_OnSubmit( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		AddText( sceneId, "  Ngß½i hãy xác nh§n c¥n cßŞng chª ly hôn không? Sau khi li hôn phu thê hai ngß¶i ğµ häo hæu xu¯ng còn 10, ğ°ng th¶i t¤t cä kÛ nång phu thê s¨ m¤t hªt#rYêu c¥u cßŞng bÑc ly hôn c¥n hao phí #{_EXCHG200000}" )
		AddNumText( sceneId, x806004_g_ScriptId, "Có", 6, 1 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨µÄÍ¼±ê (Ñ¡ÏîÍ¼±êÎªÊı×ÖÏî)
		AddNumText( sceneId, x806004_g_ScriptId, "Không", 8, 2 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨µÄÍ¼±ê (Ñ¡ÏîÍ¼±êÎªÊı×ÖÏî)
	EndEvent( sceneId )
...
function x806004_OnAccept( sceneId, selfId )
	...
	LuaFnSendSystemMail( sceneId, SpouseName, selfName .. "ğã ch÷n cßŞng chª ly hôn v¾i ngß½i, tùy vào duyên s¯ v§y" )
	--LuaFnSendNormalMail( sceneId, selfId, SpouseName, selfName .. "ğã ch÷n cßŞng chª ly hôn v¾i ngß½i, tùy vào duyên s¯ v§y" )
