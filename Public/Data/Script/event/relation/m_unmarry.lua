...
x806005_g_msg_unm["gld"]	= "  Nhà trai c¥n mang theo #{_EXCH55555} m¾i có th¬ ly hôn"
...
function x806005_OnSubmit( sceneId, selfId, targetId, tId )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "  Ch¶ ðþi ð¯i phß½ng h°i ðáp...#r  Sau khi li hôn phu thê hai ngß¶i ðµ häo hæu xu¯ng còn 10, ð°ng th¶i t¤t cä kÛ nång phu thê s¨ m¤t hªt.#Chú ý: Ly hôn nhà trai c¥n tiêu phí #{_EXCHG55555}" )
	EndEvent( sceneId )
	DispatchEventList( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		AddText( sceneId, "  Ngß½i có ð°ng ý v¾i "..selfName.." ly hôn không? Sau khi li hôn phu thê hai ngß¶i ðµ häo hæu xu¯ng còn 10, ð°ng th¶i t¤t cä kÛ nång phu thê s¨ m¤t hªt.#Chú ý: Ly hôn nhà trai c¥n tiêu phí #{_EXCHG55555}" )
		AddNumText( sceneId, x806005_g_ScriptId, "Có", 6, 1 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨µÄÍ¼±ê (Ñ¡ÏîÍ¼±êÎªÊý×ÖÏî)
		AddNumText( sceneId, x806005_g_ScriptId, "Không", 8, 2 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨µÄÍ¼±ê (Ñ¡ÏîÍ¼±êÎªÊý×ÖÏî)
	EndEvent( sceneId )
...
function x806005_OnAccept( sceneId, male, female )
	...
	--(4)ÁÄÌì´°¿Ú¸øÄÐ·½ÌáÊ¾
	Msg2Player( sceneId, male, "Ngß½i ðã tr· v« trÕng thái ðµc thân", MSG2PLAYER_PARA )
--Msg2Player( sceneId, male, "ÒÑ¾­¹é»¹ÁË½á»é½äÖ¸¡£", MSG2PLAYER_PARA )
	...
	--(5)ÁÄÌì´°¿Ú¸øÅ®·½ÌáÊ¾
	Msg2Player( sceneId, female, "Ngß½i ðã tr· v« trÕng thái ðµc thân", MSG2PLAYER_PARA )
