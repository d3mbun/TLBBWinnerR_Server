...
x806008_g_Recruit["Name"]	= "Ð° ð® phäi bái ta làm sß phø"
...
x806008_g_msg["ts"]	= "  Ðã là quan h® sß ð° r°i, không th¬ bái sß"
...
function x806008_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == -1 then
		...
		BeginEvent( sceneId )
				AddText( sceneId, "  Sau khi bái sß, giªt quái có th¬ ðÕt ðßþc 10% kinh nghi®m gia thành. Nªu có sß phø cùng nh§p nhóm, ðÕt ðßþc 20% kinh nghi®m gia thành" )
				AddText( sceneId, "  Sau khi bái sß, ð° ð® s¨ ðÕt ðßþc danh xßng "..MasterName.." ð® tØ" )
				AddText( sceneId, "  Ngß½i có thñc lòng mu¯n bái "..MasterName.." làm sß phø?" )
				AddNumText( sceneId, x806008_g_ScriptId, "Có", 6, 1 )
				AddNumText( sceneId, x806008_g_ScriptId, "Không", 8, 0 )
		EndEvent( sceneId )
