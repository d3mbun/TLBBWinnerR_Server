...
x229009_g_ExchangeTitle = "Ð±i danh xßng"
x229009_g_MissionInfo = "Ð¬ khuyªn khích các ð® tØ phát dß½ng quang ðÕi môn phái cüa mình, sß phø ðã chu¦n b¸ 1 ph¥n quà, sØ døng #R400#W ði¬m c¯ng hiªn môn phái có th¬ ð±i"  --ÈÎÎñÃèÊö
...
x229009_g_menpainpc_table =  {
	...
	{menpaiid=MP_XINGSU, 	 menpainame="Tinh Túc", name="Ðinh Xuân Thu", title="Chß·ng môn cüa phái Tinh Túc",	x=142, z=55},
	{menpaiid=MP_TIANSHAN, menpainame="Thiên S½n", name="Mai Kiªm",	 title="ÐÕi sß muµi phái Thiên S½n",	x=91, z=44},
	{menpaiid=MP_XIAOYAO,  menpainame="Tiêu Dao", name="Tô Tinh Hà", title="TÕm Quy«n Chß·ng Môn Tiêu Dao",	x=125, z=144},
}           

--ÄÐ
x229009_g_MaleTitleInfo = {
	{tlvl=1, mpp=0,	   slt="Thiªu Lâm Hi®p Sî", mjt="Minh Giáo Hi®p Sî", gbt="Cái Bang Hi®p Sî", wdt="Võ Ðang Hi®p Sî", emt="Nga My Hi®p Sî", xxt="Tinh Túc Hi®p Sî", tlt="Thiên Long Hi®p Sî", tst="Thiên S½n Hi®p Sî", xyt="Tiêu Dao Hi®p Sî"},
	{tlvl=2, mpp=1000, slt="BÕch Y Th¸ Giä", mjt="Th¸ Hoä Hi®p Sî", gbt="BÕch Liên Ð® TØ", wdt="BÕch Vân Cß Sî", emt="Minh Nguy®t Cß Sî", xxt="Hành ‘n Nß½ng TØ", tlt="Tàng Kinh Hi®p Sî", tst="HÕo Thiên Bµ Chúng", xyt="Thì Hoa Cß Sî"},
	{tlvl=3, mpp=2500, slt="Ðµ Thª Quan Âm", mjt="Hµ Giáo Tán Nhân", gbt="Chu Tß¾c Trß·ng Lão", wdt="Thanh T¸nh Tán Nhân", emt="Kim Phßþng Hi®p Sî", xxt="ÐoÕt M®nh DÕ Xoa", tlt="Sùng Thánh Thiên Sî", tst="Thiên S½n Tuyªt Kê", xyt="Lång Ba Hi®p Sî"},
	{tlvl=4, mpp=5000, slt="Già Lam B° Tát", mjt="Quang Minh Thánh Sî", gbt="Chß·ng Bát Long Sî", wdt="Võ Ðang Tiên TØ", emt="Nga My Tiên TØ", xxt="Ðµc Thü Dßþc Vß½ng", tlt="Thiên Nam Long Sî", tst="H²n Nguyên Hoa Th¥n", xyt="Tiêu Dao Thánh Sî"},
}
--Å®	
x229009_g_femaleTitleInfo = {	
	...
	{tlvl=2, mpp=1000, slt="BÕch Y Th¸ Giä", mjt="Th¸ Hoä Hi®p Næ", gbt="BÕch Liên Ð® TØ", wdt="BÕch Vân Cß Sî", emt="Minh Nguy®t Cß Sî", xxt="Hành ‘n Nß½ng TØ", tlt="Tàng Kinh Hi®p Næ", tst="HÕo Thiên Bµ Chúng", xyt="Thì Hoa Cß Sî"},
	...
	{tlvl=4, mpp=5000, slt="Già Lam B° Tát", mjt="Quang Minh Thánh Næ", gbt="Chß·ng Bát Long Næ", wdt="Võ Ðang Tiên TØ", emt="Nga My Tiên TØ", xxt="Ðµc Thü Dßþc Vß½ng", tlt="Thiên Nam Long Næ", tst="H²n Nguyên Hoa Th¥n", xyt="Tiêu Dao Thánh Næ"},
}
	...
	for i, v in x229009_g_menpainpc_table do
		if v.name == GetName(sceneId, targetId) then
			if v.menpaiid == GetMenPai(sceneId, selfId) then
				...
				local str = "Ngß½i không phäi là ð® tØ cüa môn phái này, ta chï phøc vø cho ð® tØ môn pháiNgß½i không phäi là ð® tØ cüa môn phái này, ta chï phøc vø cho ð® tØ môn phái"
				BeginEvent(sceneId)
					AddText(sceneId, str)
				EndEvent()
...
function x229009_ExchangeItemBymenpaipointFn( sceneId, selfId,targetId, needPoint )
	...
	if menpaipoint < 400 then
		local str = "Ðµ c¯ng hiªn sß môn cüa ngß½i hi®n là " .. tostring(menpaipoint) .. ", vçn không ðü 400 ði¬m, hãy c¯ lên!"
		BeginEvent(sceneId)
			AddText(sceneId, str)
		EndEvent()
		DispatchMissionTips(sceneId, selfId)
