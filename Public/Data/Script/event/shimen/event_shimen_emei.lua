...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x229003_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»
...
x229003_g_ContinueInfo="Làm t¯t l¡m"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x229003_g_MissionComplete="Vi®c ta giao ğã hoàn thành chßa?"					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x229003_g_FormatList = {
								"Lâu l¡m không g£p %n r°i, nh¾ quá ği. Ğây %s là chút lòng thành cüa ta, xin ngß½i hãy ğßa t¾i giúp ta. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Nga My tìm #RDß½ng TÑ Nß½ng #W#{_INFOAIM86,142,15, Dß½ng TÑ Nß½ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"Cüa ta %i sao không th¤y ğâu? Nªu ngß½i có th¬ giúp ta tìm lÕi, ta s¨ không bÕc ğãi ngß½i. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Nga My tìm #RDß½ng TÑ Nß½ng #W#{_INFOAIM86,142,15, Dß½ng TÑ Nß½ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%n làm ği«u ác, ta phäi ği dÕy bäo, ğáng tiªc không có th¶i gian, ngß½i có th¬ làm thay ğßşc không? #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Nga My tìm #RDß½ng TÑ Nß½ng #W#{_INFOAIM86,142,15, Dß½ng TÑ Nß½ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"Xin ngß½i hãy · núi Nga My %s tìm th¤y %s, hãy dùng %s ğ¬ cho nó ån. #R #e00f000Nh¡c nhö: #e000000#r khi ngß½i t¾i g¥n Phøng Hoàng ğang c¥n cho ån, ¤n #gfff0f0Alt+A#g000000 có th¬ m· møc v§t ph¦m, ¤n vào#gfff0f0\" nhi®m vø\"#g000000giao di®n có th¬ m· ra møc v§t ph¦m nhi®m vø, nh¤p phím phäi#gfff0f0 Nga My Tiên Lµ#g000000, là có th¬ hoàn t¤t vi®c cho ån.",
								"Xin ngß½i hãy ği tìm th¤y %s, ông ta s¨ ğßa ngß½i ği thØ chiªn %s. #R #e00f000Nh¡c nhö: #e000000#r Chß·ng môn MÕnh Thanh Thanh · núi Nga My #{_INFOAIM96,73,15, MÕnh Thanh Thanh}. ",
								...
								"Xin ngß½i hãy · núi Nga My tìm kiªm 4 phß½ng, tìm cho ta 5 %s. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ tìm th¤y nút vàng trong bän ğ° nhö · góc phäi màn hình. #R Ngß½i có th¬ tìm th¤y #Yğ° trang sÑc b¸ m¤t#W trên ngß¶i #Rcon khï ğen#W. #R Ngß½i có th¬ tìm th¤y #Yğ° cúng tª b¸ m¤t#W trên ngß¶i #Rcon khï vàng#W. #R Ngß½i có th¬ tìm th¤y #Ychâu báu b¸ m¤t#W trên ngß¶i #Rcon khï tr¡ng#W.",
								"Hãy ğßa %s t¾i 1 cái %i, làm xong, ta s¨ h§u thß·ng cho ngß½i! #R #e00f000Nh¡c nhö: #e000000#r Ğào Hoa S½n · núi Nga My #{_INFOAIM156,99,15, Ğào Hoa S½n}. #R Ğào Di®p Tiên#W · núi Nga My #{_INFOAIM156,112,15, Ğào Di®p Tiên}. #R Ğào Chi S½n · núi Nga My #{_INFOAIM156,106,15,Ğào Chi S½n}. ",
								"Ği giªt chªt %s %s %n.",
								}
...
x229003_g_DingDianYinDaoList = {
											 {menpai=MP_EMEI     , itemId=40003030, itemName="Nga my tiên lµ ", scene=15, AreaName="Cây xuân c± thø và màn sß½ng", subAreaName="Kim Ğïnh Phøng Hoàng", posx1=39, posz1=32, posx2=57, posz2=46},
											 ...
											 {menpai=MP_EMEI     , itemId=40003030, itemName="Nga my tiên lµ ", scene=15, AreaName="Tß Ngæ Ğài", subAreaName="Ph§t Quang Phøng Hoàng", posx1=32, posz1=139, posx2=46, posz2=160},
											 {menpai=MP_EMEI     , itemId=40003030, itemName="Nga my tiên lµ ", scene=15, AreaName="Trß¶ng Sinh Ği®n ", subAreaName="VÕn Niên Phøng Hoàng", posx1=132, posz1=148, posx2=160, posz2=160},
											}


--¸±±¾ÁĞ±í
x229003_g_FuBen_List = {
								{menpai=MP_EMEI     , NpcName="MÕnh Thanh Thanh", scene=15, posx=96, posz=73, FubenName="Ğào Hoa Tr§n phø bän"},
								}       
...
x229003_g_AbilityNpcList = {
                    {menpai=MP_EMEI     ,npcList={{name="Ğào hoa tiên", scene=15, x=156, z=99},
                                                  {name="Ğào Di®p Tiên", scene=15, x=156, z=112},
                                                  {name="Ğào Chi Tiên", scene=15, x=156, z=106}}
										},
									}
...
function x229003_KillMonster_Accept(sceneId, selfId)--É±¹Ö
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 8)--formet×Ö·û´®Ë÷Òı
...
function x229003_XunWu_Accept(sceneId, selfId)--Ñ°Îï
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 1)--formet×Ö·û´®Ë÷Òı
...
function x229003_SongXin_Accept(sceneId, selfId)--ËÍĞÅ
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 0)--formet×Ö·û´®Ë÷Òı
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart+3, shoujiItemId )
	...
	local strMissionTarget = format("Lâu l¡m không g£p %s %s, ngß½i hãy giúp ta ğem %s giao cho ngß¶i ¤y", strNpcScene, strNpcName, x229003_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_DingDianYinDao_Accept(sceneId, selfId)--¶¨ ği¬mÒıµ¼
	-- ğÕt ğßşcÍæ¼ÒtoÕ ğµ ÃÅÅÉ
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--ÓÃmµt cáiÁÙÊ±±íÀ´´æ´¢¶ÔÓ¦ÃÅÅÉTÕi x229003_g_DingDianYinDaoListÖĞtoÕ ğµ È«²¿Ë÷Òı
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#YNgß½i ğã ğÕt ğßşc 1 chiªc#W" .. x229003_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 3)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy · núi Nga My %s tìm th¤y %s, hãy dùng %s ğ¬ cho nó ån", 
...
function x229003_BuZhuo_Accept(sceneId, selfId)--²¶×½
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 5)--formet×Ö·û´®Ë÷Òı
...
function x229003_ShouJi_Accept(sceneId, selfId)--ÊÕ¼¯
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 6)--formet×Ö·û´®Ë÷Òı
...
function x229003_Ability_Accept(sceneId, selfId)--¿ª¹â
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 7)--formet×Ö·û´®Ë÷Òı
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x229003_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
...
function x229003_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229003_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229003_g_MissionId)		-- ği¬mµ½ÈÎÎñTÕi 20cáiÈÎÎñÖĞtoÕ ğµ ĞòÁĞºÅ
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x229003_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229003_g_MissionId)
