...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x229008_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»
...
x229008_g_ContinueInfo="Làm t¯t l¡m"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x229008_g_MissionComplete="Vi®c ta giao ğã hoàn thành chßa?"					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x229008_g_FormatList = {
								"Lâu l¡m không g£p %n r°i, nh¾ quá ği. Ğây %s là chút lòng thành cüa ta, xin ngß½i hãy ğßa t¾i giúp ta. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn T±ng ğà Cái Bang tìm #RTrß½ng Toàn Tß¶ng #W#{_INFOAIM93,118,10, Trß½ng Toàn Tß¶ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%i cüa ta sao không th¤y ğâu? Nªu ngß½i có th¬ giúp ta tìm lÕi, ta s¨ không bÕc ğãi ngß½i. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn T±ng ğà Cái Bang tìm #RTrß½ng Toàn Tß¶ng #W#{_INFOAIM93,118,10, Trß½ng Toàn Tß¶ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%n làm ği«u ác, ta phäi ği dÕy bäo, ğáng tiªc không có th¶i gian, ngß½i có th¬ làm thay ğßşc không? #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn T±ng ğà Cái Bang tìm #RTrß½ng Toàn Tß¶ng #W#{_INFOAIM93,118,10, Trß½ng Toàn Tß¶ng}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"Xin ngß½i hãy dùng %s, · Cái Bang %s, dùng %s l¤y rßşu. #R #e00f000Nh¡c nhö: #e000000#r Khi t¾i g¥n vò rßşu c¥n l¤y, ¤n #gfff0f0Alt+A#g000000 có th¬ m· møc v§t ph¦m, ¤n vào#gfff0f0\" Nhi®m vø\"#g000000 giao di®n có th¬ m· ra møc v§t ph¦m nhi®m vø, nh¤p phím phäi #gfff0f0TØu ğàn#g000000, là có th¬ l¤y ğßşc rßşu.",
								"Xin ngß½i hãy ği tìm th¤y %s, ông ta s¨ ğßa ngß½i ği thØ chiªn %s. #R #e00f000Nh¡c nhö: #e000000#r Ph§t „n huynh ğ® · T±ng ğà Cái Bang #{_INFOAIM41,144,10, Ph§t „n}. ",
								...
								"Xin ngß½i hãy · Cái Bang ğÕi vi®n tìm kiªm 4 phß½ng, tìm cho ta 5 %s. #R #e00f000Nh¡c nhö: #e000000#r ngß½i có th¬ tìm th¤y nút vàng trong bän ğ° nhö · góc phäi màn hình.",
								"Hãy ğßa %s t¾i 1 cái %i, làm xong, ta s¨ h§u thß·ng cho ngß½i! #R #e00f000Nh¡c nhö: #e000000#r Toàn Quân Thanh ğà chü · t±ng ğà Cái Bang #{_INFOAIM120,63,10, Toàn Quân Thanh}. #RTr¥n Cô NhÕn trß·ng lão · t±ng ğà Cái Bang #{_INFOAIM91,98,10, Tr¥n Cô NhÕn}. #R Ngô Trß¶ng Phong trß·ng lão · t±ng ğà Cái Bang #{_INFOAIM114,91,10,Ngô Trß¶ng Phong}. ",
								"Ği giªt chªt %s %s %n.",
								}
...
x229008_g_DingDianYinDaoList = {
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="Vò rßşu", scene=10, AreaName="Ti¬u ğào viên", subAreaName="vò rßşu", posx1=33, posz1=141, posx2=48, posz2=156},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="Vò rßşu", scene=10, AreaName="Ğ² khang t×", subAreaName="vò rßşu", posx1=124, posz1=106, posx2=137, posz2=115},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="Vò rßşu", scene=10, AreaName="Di­n binh ğàn", subAreaName="vò rßşu", posx1=41, posz1=32, posx2=53, posz2=42},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="Vò rßşu", scene=10, AreaName="Tây sß½ng phòng", subAreaName="vò rßşu", posx1=48, posz1=83, posx2=62, posz2=93},
											}


--¸±±¾ÁĞ±í
x229008_g_FuBen_List = {
								{menpai=MP_GAIBANG  , NpcName="Ph§t „n", scene=10, posx=41, posz=144, FubenName="Phø bän h¥m rßşu"},
								}       

--ÊÕ¼¯
x229008_g_ShouJiList = {
								{menpai=MP_GAIBANG  , scene=10, itemId=40003008, itemName="Ti¬u thanh xà"},-- count=5},
								{menpai=MP_GAIBANG  , scene=10, itemId=40003009, itemName="Ti¬u bÕch xà"},-- count=5},
								{menpai=MP_GAIBANG  , scene=10, itemId=40003010, itemName="Ti¬u hoàng xà"},-- count=5},
							}	
...
x229008_g_AbilityNpcList = {
                    {menpai=MP_GAIBANG  ,npcList={{name="Toàn Quán Thanh", scene=10, x=120, z=63},
                                                  {name="Tr¥n Cô NhÕn", scene=10, x=91, z=99},
                                                  {name="Ngô Trß¶ng Phong", scene=10, x=114, z=81}}
										},
									}
...
function x229008_KillMonster_Accept(sceneId, selfId)--É±¹Ö
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 8)--formet×Ö·û´®Ë÷Òı
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_XunWu_Accept(sceneId, selfId)--Ñ°Îï
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 1)--formet×Ö·û´®Ë÷Òı
...
function x229008_SongXin_Accept(sceneId, selfId)--ËÍĞÅ
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 0)--formet×Ö·û´®Ë÷Òı
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart+3, x229008_g_Xin_ItemId )
	...
	local strMissionTarget = format("Lâu l¡m không g£p %s %s, ngß½i hãy giúp ta ğem %s giao cho ngß¶i ¤y.", strNpcScene, strNpcName, x229008_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_DingDianYinDao_Accept(sceneId, selfId)--¶¨ ği¬mÒıµ¼
	-- ğÕt ğßşcÍæ¼ÒtoÕ ğµ ÃÅÅÉ
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--ÓÃmµt cáiÁÙÊ±±íÀ´´æ´¢¶ÔÓ¦ÃÅÅÉTÕi x229008_g_DingDianYinDaoListÖĞtoÕ ğµ È«²¿Ë÷Òı
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#YNgß½i ğã ğÕt ğßşc 1 chiªc " .. x229008_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 3)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy dùng %s, · Cái Bang %s, dùng %s l¤y rßşu.", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_FuBenZhanDou_Accept(sceneId, selfId)--Cuµc chiªn ¸±±¾
	local playerMenpai = GetMenPai(sceneId, selfId)
...
function x229008_BuZhuo_Accept(sceneId, selfId)--²¶×½
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 5)--formet×Ö·û´®Ë÷Òı
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_ShouJi_Accept(sceneId, selfId)--ÊÕ¼¯
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 6)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy giúp ta kiªm 5 %s v«.", x229008_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_Ability_Accept(sceneId, selfId)--¿ª¹â
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 7)--formet×Ö·û´®Ë÷Òı
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x229008_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
...
function x229008_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229008_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229008_g_MissionId)		-- ği¬mµ½ÈÎÎñTÕi 20cáiÈÎÎñÖĞtoÕ ğµ ĞòÁĞºÅ
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x229008_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229008_g_MissionId)
