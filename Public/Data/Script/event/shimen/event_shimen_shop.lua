...
function x229012_OnDefaultEvent( sceneId, selfId,targetId )
	...
	if(NumText == 1) then
		BeginEvent(sceneId)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 2", 7, 3)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 3", 7, 4)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 4", 7, 5)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 5", 7, 6)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 6", 7, 7)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 7", 7, 8)
		EndEvent(sceneId)
	...
	elseif(NumText == 2) then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 6", 7, 7)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 7", 7, 8)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 8", 7, 9)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 9", 7, 10)
			AddNumText(sceneId,x229012_g_scriptId, "Ph¯i phß½ng c¤p 10", 7, 11)
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
