...
x229010_g_MissionTarget = "Khá l¡m...... — b±n môn ta, ngß½i luôn phát dß½ng quang ğÕi, t§n tâm t§n lñc, c¥n cù làm vi®c. Ta s¨ giao cho ngß½i 1 nhi®m vø khác., #G%s#Wv×a ğßa cho ta b° câu ğßa thß, nói h÷ c¥n giúp ğŞ, ngß½i ği tìm ği #G%s#W cüa#Y%s#W, ông (bà) ta s¨ s¡p xªp nhi®m vø cüa ngß½i.#r#{SMRW_090206_01}"
x229010_g_ContinueInfo="Làm t¯t l¡m"		--Î´Íê³ÉÈÎÎñµÄnpc¶Ô»°
x229010_g_MissionComplete="Vi®c ta giao ğã hoàn thành chßa?"					--Íê³ÉÈÎÎñnpcËµ»°µÄ»°
...
x229010_g_StrList = {
						"Huy«n Trình#{_INFOAIM61,61,9, Huy«n Trình}",
						"Tháp Lâm phø bän",
						"Bän Tß¾ng#{_INFOAIM35,86,13, Bän Tß¾ng}",
