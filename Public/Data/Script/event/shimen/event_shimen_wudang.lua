...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x229002_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»
...
x229002_g_ContinueInfo="Làm t¯t l¡m"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x229002_g_MissionComplete="Vi®c ta giao ğã hoàn thành chßa?"					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x229002_g_FormatList = {
								"Lâu l¡m không g£p %n r°i, nh¾ quá ği. Ğây %s là chút lòng thành cüa ta, xin ngß½i hãy ğßa t¾i giúp ta. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Võ Ğang tìm #RMÕc Thái Xung #W#{_INFOAIM101,136,12, MÕc Thái Xung}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%i cüa ta sao không th¤y ğâu? Nªu ngß½i có th¬ giúp ta tìm lÕi, ta s¨ không bÕc ğãi ngß½i. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Võ Ğang tìm #RMÕc Thái Xung #W#{_INFOAIM101,136,12, MÕc Thái Xung}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%n làm ği«u ác, ta phäi ği dÕy bäo, ğáng tiªc không có th¶i gian, ngß½i có th¬ làm thay ğßşc không? #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn núi Võ Ğang tìm #RMÕc Thái Xung #W#{_INFOAIM101,136,12,MÕc Thái Xung}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"Xin ngß½i hãy dùng %s, · Võ Ğang %s thu th§p linh khí trong %s. #R #e00f000Nh¡c nhö: #e000000#r khi ngß½i t¾i n½i c¥n thu th§p linh khí, ¤n #gfff0f0Alt+A#g000000 có th¬ m· møc v§t ph¦m, ¤n vào#gfff0f0\"nhi®m vø\"#g000000giao di®n có th¬ m· ra møc v§t ph¦m nhi®m vø, nh¤p phím phäi#gfff0f0 TØ Kim H° Lô#g000000, là có th¬ hoàn thành vi®c thu th§p.",
								"Xin ngß½i hãy ği tìm th¤y %s, huynh ¤y s¨ ğßa ngß½i ği thØ chiªn %s. #R #e00f000Nh¡c nhö: #e000000#r Lâm Linh T¯ sß huynh · núi Võ Ğang #{_INFOAIM58,73,12, Lâm Linh T¯}. ",
								...
								"Xin ngß½i hãy · núi Võ Ğang tìm kiªm 4 phß½ng, tìm cho ta 5 %s. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ tìm th¤y nút vàng trong bän ğ° nhö · góc phäi màn hình.",
								"Hãy ğßa %s t¾i 1 cái %i, làm xong, ta s¨ h§u thß·ng cho ngß½i! #R #e00f000Nh¡c nhö: #e000000#r Thanh Minh Vân HÕc · núi Võ Ğang #{_INFOAIM102,108,12, Thanh Minh Vân HÕc}. #R CØu Thiên Th¥n HÕc · núi Võ Ğang #{_INFOAIM86,84,12, CØu Thiên Th¥n HÕc}. #R Vô K¸ Th¥n HÕc · núi Võ Ğang #{_INFOAIM74,85,12, Vô K¸ Th¥n HÕc}. ",
								"Ği giªt chªt %s %s %n.",
								}
...
x229002_g_DingDianYinDaoList = {
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="TØ kim h° lô", scene=12, AreaName="Kim Ği®n", subAreaName="Mây mù ", posx1=72, posz1=39, posx2=100, posz2=65},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="TØ kim h° lô", scene=12, AreaName="Giäi Kiªm Trì ", subAreaName="Mây mù ", posx1=36, posz1=170, posx2=52, posz2=190},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="TØ kim h° lô", scene=12, AreaName="H°i Long Ğài ", subAreaName="Mây mù ", posx1=70, posz1=127, posx2=86, posz2=149},
											 {menpai=MP_WUDANG   , itemId=40003019, itemName="TØ kim h° lô", scene=12, AreaName="Thiên Gi¾i ", subAreaName="Mây mù ", posx1=42, posz1=64, posx2=50, posz2=89},
											}


--¸±±¾ÁĞ±í
x229002_g_FuBen_List = {
								{menpai=MP_WUDANG   , NpcName="Lâm Linh T¯", scene=12, posx=58, posz=73, FubenName="Linh Tính Phong phø bän"},
								}       

--ÊÕ¼¯
x229002_g_ShouJiList = {
								{menpai=MP_WUDANG   , scene=12, itemId=40003021, itemName="Võ Ğang linh chi"},-- count=5},
								{menpai=MP_WUDANG   , scene=12, itemId=40003022, itemName="Võ Ğang thü ô"},-- count=5},
								{menpai=MP_WUDANG   , scene=12, itemId=40003023, itemName="Võ Ğang nhân sâm "},-- count=5},
							}	
...
x229002_g_AbilityNpcList = {
                    {menpai=MP_WUDANG   ,npcList={{name="Thanh Minh Th¥n HÕc", scene=12, x=102, z=108},
                                                  {name="CØu Thiên Th¥n HÕc", scene=12, x=87, z=85},
                                                  {name="Vô Cñc Th¥n HÕc", scene=12, x=75, z=85}}
										},
									}
...
function x229002_KillMonster_Accept(sceneId, selfId)--É±¹Ö
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 8)--formet×Ö·û´®Ë÷Òı
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_XunWu_Accept(sceneId, selfId)--Ñ°Îï
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 1)--formet×Ö·û´®Ë÷Òı
...
function x229002_SongXin_Accept(sceneId, selfId)--ËÍĞÅ
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 0)--formet×Ö·û´®Ë÷Òı
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart+3, x229002_g_Xin_ItemId )
	...
	local strMissionTarget = format("Lâu l¡m không g£p %s %s, ngß½i hãy giúp ta ğem %s giao cho ngß¶i ¤y.", strNpcScene, strNpcName, x229002_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_DingDianYinDao_Accept(sceneId, selfId)--¶¨ ği¬mÒıµ¼
	-- ğÕt ğßşcÍæ¼ÒtoÕ ğµ ÃÅÅÉ
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--ÓÃmµt cáiÁÙÊ±±íÀ´´æ´¢¶ÔÓ¦ÃÅÅÉTÕi x229002_g_DingDianYinDaoListÖĞtoÕ ğµ È«²¿Ë÷Òı
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#YNgß½i ğã ğÕt ğßşc 1 chiªc " .. x229002_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 3)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy dùng %s, · Võ Ğang %s thu th§p linh khí cüa %s.", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_FuBenZhanDou_Accept(sceneId, selfId)--Cuµc chiªn ¸±±¾
	local playerMenpai = GetMenPai(sceneId, selfId)
...
function x229002_BuZhuo_Accept(sceneId, selfId)--²¶×½
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 5)--formet×Ö·û´®Ë÷Òı
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_ShouJi_Accept(sceneId, selfId)--ÊÕ¼¯
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 6)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy giúp ta kiªm 5 %s v«.", x229002_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229002_Ability_Accept(sceneId, selfId)--¿ª¹â
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229002_g_StrForePart, 7)--formet×Ö·û´®Ë÷Òı
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x229002_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
...
function x229002_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229002_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229002_g_MissionId)		-- ği¬mµ½ÈÎÎñTÕi 20cáiÈÎÎñÖĞtoÕ ğµ ĞòÁĞºÅ
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x229002_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229002_g_MissionId)
