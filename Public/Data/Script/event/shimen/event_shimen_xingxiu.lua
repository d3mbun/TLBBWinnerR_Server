...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x229007_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»
...
x229007_g_ContinueInfo="Làm t¯t l¡m"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x229007_g_MissionComplete="Vi®c ta giao ğã hoàn thành chßa?"					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
x229007_g_FormatList = {
								"Lâu l¡m không g£p %n r°i, nh¾ quá ği. Ğây %s là chút lòng thành cüa ta, xin ngß½i hãy ğßa t¾i giúp ta. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn Tinh Túc Häi tìm #RThiên Lang TØ #W#{_INFOAIM99,150,16, Thiên Lang TØ}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%i cüa ta sao không th¤y ğâu? Nªu ngß½i có th¬ giúp ta tìm lÕi, ta s¨ không bÕc ğãi ngß½i. #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn Tinh Túc Häi tìm #RThiên Lang TØ #W#{_INFOAIM99,150,16, Thiên Lang TØ}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"%n làm ği«u ác, ta phäi ği dÕy bäo, ğáng tiªc không có th¶i gian, ngß½i có th¬ làm thay ğßşc không? #R #e00f000Nh¡c nhö: #e000000#r Ngß½i có th¬ ğªn Tinh Túc Häi tìm #RThiên Lang TØ #W#{_INFOAIM99,150,16, Thiên Lang TØ}, hãy nh¶ ông ta ğßa ngß½i t¾i các thành th¸ l¾n.",
								"Xin ngß½i hãy · Tinh Túc Häi %s tìm th¤y %s, hãy dùng %s ğ¬ cho nó ån. #R #e00f000Nh¡c nhö: #e000000#r Khi ngß½i t¾i g¥n rß½ng ğµc v§t c¥n cho ån, ¤n #gfff0f0Alt+A#g000000có th¬ m· møc v§t ph¦m, ¤n vào#gfff0f0\"nhi®m vø\"#g000000giao di®n có th¬ m· ra møc v§t ph¦m nhi®m vø, nháy phím phäi#gfff0f0Ngû Ğµc Trùng#g000000, là có th¬ hoàn t¤t vi®c cho ån.",
								"Xin ngß½i hãy ği tìm %s, muµi ¤y s¨ ğßa ngß½i ği thØ chiªn %s. #R #e00f000Nh¡c nh·: #e000000#r H°ng Ng÷c sß muµi · Tinh Túc Häi #{_INFOAIM128,78,16, H°ng Ng÷c}.",
								"Xin ngß½i hãy b¡t cho ta mµt con %p v«.#e000000#r Vân Hàm Nhi · thành LÕc Dß½ng #{_INFOAIM183,155,0, Vân Hàm Nhi} có th¬ ğßa ngß½i t¾i Huy«n Vû Ğäo, nhßng Huy«n Vû Ğäo có 1 con ğß¶ng mòn thông qua Thánh Thú S½n. Ngß½i có th¬ b¡t trân thú mà ta c¥n · Huy«n Vû Ğäo ho£c · Thánh Thú S½n.",
								"Xin ngß½i hãy ki¬m tra b¯n phía · Tinh Túc Häi, tìm cho ta 5 con %s. #R #e00f000Nh¡c nhŞ: #e000000#r Ngß½i có th¬ tìm th¤y nút vàng trong bän ğ° nhö · góc phäi màn hình.",
								"Hãy ğßa %s t¾i 1 cái %i, làm xong, ta s¨ h§u thß·ng cho ngß½i! #R #e00f000Nh¡c nhŞ: #e000000#r Tây Vñc Dßşc Lâu TØ · Tinh Túc Häi #{_INFOAIM131,48,16, Tây Vñc Dßşc Lâu TØ}. #R Khiªt Ğan Dßşc Lâu TØ · Tinh Túc Häi #{_INFOAIM136,48,16, Khiªt Ğan Dßşc Lâu TØ}. #R ĞÕi Lı Dßşc Lâu TØ · Tinh Túc Häi #{_INFOAIM142,48,16, ĞÕi Lı Dßşc Lâu TØ}.",
								"Ği giªt chªt %s %s %n.",
								}
...
x229007_g_DingDianYinDaoList = {
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="Ngû ğµc trùng", scene=16, AreaName="Nh§t Nguy®t Cung", subAreaName="rß½ng cóc ğµc", posx1=88, posz1=50, posx2=103, posz2=60},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="Ngû ğµc trùng", scene=16, AreaName="phß½ng trßşng ği®n", subAreaName="rß½ng rªt ğµc", posx1=82, posz1=94, posx2=94, posz2=102},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="Ngû ğµc trùng", scene=16, AreaName="ği®n Doanh Châu", subAreaName="rß½ng nh®n ğµc", posx1=98, posz1=94, posx2=110, posz2=102},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="Ngû ğµc trùng", scene=16, AreaName="ği®n B°ng Lai", subAreaName="rß½ng bò cÕp ğµc", posx1=119, posz1=69, posx2=132, posz2=79},
											}


--¸±±¾ÁĞ±í
x229007_g_FuBen_List = {
								{menpai=MP_XINGSU   , NpcName="H°ng Ng÷c", scene=16, posx=128, posz=78, FubenName="Ngû Th¥n Ğµng phø bän"},
								}       

--ÊÕ¼¯
x229007_g_ShouJiList = {
								{menpai=MP_XINGSU   , scene=16, itemId=40003035, itemName="Ğµc ngô công"},-- count=5},
								{menpai=MP_XINGSU   , scene=16, itemId=40003036, itemName="Ğµc thi«m th×"},-- count=5},								
								{menpai=MP_XINGSU   , scene=16, itemId=40003037, itemName="Ğµc tri thù"},-- count=5},								
							}	
...
x229007_g_AbilityNpcList = {
                    {menpai=MP_XINGSU   ,npcList={{name="Tây vñc Dßşc Lâu TØ", scene=16, x=131, z=48},
                                                  {name="Khiªt Ğan Dßşc Lâu TØ", scene=16, x=136, z=48},
                                                  {name="ĞÕi Lı Dßşc Lâu TØ", scene=16, x=142, z=48}}
										},
									}
...
function x229007_KillMonster_Accept(sceneId, selfId)--É±¹Ö
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 8)--formet×Ö·û´®Ë÷Òı
...
function x229007_XunWu_Accept(sceneId, selfId)--Ñ°Îï
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 1)--formet×Ö·û´®Ë÷Òı
...
function x229007_SongXin_Accept(sceneId, selfId)--ËÍĞÅ
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 0)--formet×Ö·û´®Ë÷Òı
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart+3, x229007_g_Xin_ItemId )
	...
	local strMissionTarget = format("Lâu l¡m không g£p %s %s, ngß½i hãy giúp ta ğem %s giao cho ngß¶i ¤y.", strNpcScene, strNpcName, x229007_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_DingDianYinDao_Accept(sceneId, selfId)--¶¨ ği¬mÒıµ¼
	-- ğÕt ğßşcÍæ¼ÒtoÕ ğµ ÃÅÅÉ
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--ÓÃmµt cáiÁÙÊ±±íÀ´´æ´¢¶ÔÓ¦ÃÅÅÉTÕi x229007_g_DingDianYinDaoListÖĞtoÕ ğµ È«²¿Ë÷Òı
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#YNgß½i ğã ğÕt ğßşc 1 chiªc #W" .. x229007_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 3)--formet×Ö·û´®Ë÷Òı
	...
	local strMissionTarget = format("Xin ngß½i hãy · Tinh Túc Häi %s tìm th¤y %s, hãy dùng %s ğ¬ cho nó ån", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_FuBenZhanDou_Accept(sceneId, selfId)--Cuµc chiªn ¸±±¾
	local playerMenpai = GetMenPai(sceneId, selfId)
...
function x229007_BuZhuo_Accept(sceneId, selfId)--²¶×½
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 5)--formet×Ö·û´®Ë÷Òı
...
function x229007_ShouJi_Accept(sceneId, selfId)--ÊÕ¼¯
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 6)--formet×Ö·û´®Ë÷Òı
...
function x229007_Ability_Accept(sceneId, selfId)--¿ª¹â
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 7)--formet×Ö·û´®Ë÷Òı
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x229007_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
...
function x229007_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229007_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229007_g_MissionId)		-- ği¬mµ½ÈÎÎñTÕi 20cáiÈÎÎñÖĞtoÕ ğµ ĞòÁĞºÅ
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x229007_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229007_g_MissionId)
