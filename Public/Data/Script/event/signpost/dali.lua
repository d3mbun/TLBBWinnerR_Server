...
x500040_g_Signpost = {
		{ type=1, name="Làm sao gia nh§p môn phái?", eventId=500049, x=0, y=0, tip=" ", desc=" " },		--×¢Òâ£¬ÕâÒ»Ìõ²»ÊÇµ÷ÓÃÁíÒ»¸ö½Å±¾µÄ·½Ê½£¬¶øÊÇÔÚ±¾ÎÄ¼şÄÚÖ±½ÓÅĞ¶Ï¡£²»½¨ÒéÊ¹ÓÃ´ËÖÖ·½Ê½
		...
		{ type=1, name="H÷c 1 s¯ kÛ nång ğ¶i s¯ng", eventId=500046, x=0, y=0, tip=" ", desc=" " },
...
--	end
	...
	if GetNumText()==1 then
		...
		CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, sceneId, 241, 136, "Thôi Phùng CØu" )
		return
	end
