...
x500048_g_Signpost = {
	{ type=2, name="Võ quán quán chü", x=96, y=221, tip="Phøng Tri«u Dß½ng", desc="Lôi Ðài là n½i h÷c höi võ ngh®, các hÕ có th¬ tìm chü quän Phøng Tri«u Dß½ng mu¯n tìm hi¬u g£p ông trên Thßþng Võ ðài. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
