...
x500000_g_Signpost = {
		...
		{ type=1, name="H÷c 1 s¯ kÛ nång ð¶i s¯ng", eventId=500005, x=0, y=0, tip=" ", desc=" " },
...
--{ type=2, name="¶«Éý¿ÍÕ»", x=100.7, y=124.2, tip="ÂåÑô¶«Éý¿ÍÕ»", desc="ÂåÑô×î´óµÄ¿ÍÕ»Ö®Ò»£¬Èý½Ì¾ÅÁ÷¾Û¼¯Ö®µØ¡£" },
...
--	end
	...
	if GetNumText()==1 then
		...
		CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, sceneId, 150, 91, "Lßu Ki®n Minh" )
		return
	end
	...
	if GetNumText()==2 then
		...
		EndEvent(sceneId)
		DispatchEventList(sceneId, selfId, targetId)
		CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, sceneId, 139, 182, "Ngô ÐÑc Xß½ng" )
		return
	end
