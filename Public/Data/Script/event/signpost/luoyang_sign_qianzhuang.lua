...
x500003_g_Signpost = {
	...
	{ type=2, name="Ti«n trang", x=80, y=152, tip="Dß½ng Hy Bình", desc="VÕn kim ti«n trang lão bän Dß½ng Hy Bình (80, 152) · Ti«n Trang trong ðß¶ng l¾n phía Tây, nô bµc cüa ông có th¬ giúp các hÕ c¤t giæ v§t phçm và ngân lßþng. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
	{ type=2, name="Kim Nguyên Bäo Thß½ng", x=206, y=172, tip="Kim Løc Gia", desc="Kim Nguyên Bäo Thß½ng Nhân Kim Løc Gia (206, 172) · Ðông Th¸. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
