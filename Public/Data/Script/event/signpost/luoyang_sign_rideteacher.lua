...
x500010_g_Signpost = {
	{ type=2, name="KÜ", x=136, y=180, tip="Ði«n Kiêu Minh", desc="TÕi D¸ch TrÕm · giæa Tây Th¸ và ðß¶ng l¾n phía Nam, tìm t¾i Ði«n Kiêu Minh, có th¬ mua v§t cßÞi s½ c¤p", eventId=-1 },
}
