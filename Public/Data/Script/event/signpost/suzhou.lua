...
x500020_g_Signpost = {
		...
		{ type=2, name="Nh§n kinh nghi®m nhân ðôi?", x=164, y=80, tip="Th¦m Trình", desc="Ngß½i có th¬ · ch² Th¦m Trình (164, 80) lãnh g¤p ðôi kinh nghi®m, ông · g¥n B¡c Môn Tô Châu. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
...
--{ type=2, name="¶«Éý¿ÍÕ»", x=100.7, y=124.2, tip="ËÕÖÝ¶«Éý¿ÍÕ»", desc="ËÕÖÝ×î´óµÄ¿ÍÕ»Ö®Ò»£¬Èý½Ì¾ÅÁ÷¾Û¼¯Ö®µØ¡£" },
...
--	end
	...
	if GetNumText()==1 then
		...
		CallScriptFunction( SCENE_SCRIPT_ID, "AskTheWay", sceneId, selfId, sceneId, 111, 160, "Àî³Ë·ç" )
		return
	end
