...
x500026_g_Signpost = {
	{ type=2, name="Lý Th×a Phong", x=111, y=160, tip="Lý Th×a Phong", desc="Ông chü D¸ch trÕm Lý Th×a Phong (111, 160) · trên ðß¶ng hß¾ng Ðông Nam Môn Tây Th¸. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
