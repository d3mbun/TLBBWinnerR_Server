...
x050101_g_MissionTarget = "    Hoa Kiªm Änh · Tô Châu #{_INFOAIM251,108,1, Hoa Kiªm Änh} yêu c¥u các hÕ giªt chªt 80 con Dã Hùng và H°ng Hùng Vß½ng.#r    #{FQSH_090206_01}"						-- Møc tiêu nhi®m vø
...
function x050101_OnKillObject( sceneId, selfId, objdataId, objId )						-- ²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
	...
	if GetName(sceneId, objId) ~= "Dã Hùng" then
		GroupID = 2;
	end
