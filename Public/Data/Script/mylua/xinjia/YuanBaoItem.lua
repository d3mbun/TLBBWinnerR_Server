...
function x900042_OnActivateOnce( sceneId, selfId )
    ...
    x900042_ShowNotice( sceneId, selfId, "Các hÕ ğã nh§n ğßşc "..(x900042_g_YuanBaoInfo[itemTblIndex][1]).." Nguyên bäo" )
	YuanBao(sceneId,selfId,-1,1,x900042_g_YuanBaoInfo[itemTblIndex][1])
	end
	if x900042_g_YuanBaoInfo[itemTblIndex][2] == 2 then
    --x900042_ShowNotice( sceneId, selfId, "Các hÕ ğã nh§n ğßşc "..(x900042_g_YuanBaoInfo[itemTblIndex][1]).." Vàng" )
	AddMoney(sceneId,selfId,x900042_g_YuanBaoInfo[itemTblIndex][1]*10000)
	end
	if x900042_g_YuanBaoInfo[itemTblIndex][2] == 3 then
       	x900042_ShowNotice( sceneId, selfId, "Các hÕ ğã nh§n ğßşc "..(x900042_g_YuanBaoInfo[itemTblIndex][1]).." Ği¬m t£ng" )
