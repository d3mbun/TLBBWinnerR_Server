...
function x100012_OnDeplete( sceneId, selfId )
	...
	if guildid == -1 then
		x100012_ShowNotice( sceneId, selfId, "Các hÕ chßa gia nh§p bang hµi, tÕm th¶i không th¬ sØ døng." )
		return 1
	end
...
function x100012_OnActivateOnce( sceneId, selfId )
	...
	BeginEvent(sceneId)
       x100012_ShowNotice( sceneId, selfId, "Chúc m×ng bang hµi các hÕ ðã tång ðµ Qu¯c phòng 200 ði¬m." )
	return 1;
end
