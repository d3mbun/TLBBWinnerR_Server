...
function x100013_OnDeplete( sceneId, selfId )
	...
	if guildid == -1 then
		x100013_ShowNotice( sceneId, selfId, "Các hÕ chßa gia nh§p bang hµi, tÕm th¶i không th¬ sØ døng." )
		return 1
	end
...
function x100013_OnActivateOnce( sceneId, selfId )
	...
	BeginEvent(sceneId)
       x100013_ShowNotice( sceneId, selfId, "Chúc m×ng bang hµi các hÕ ðã tång ðµ Khoa h÷c 200 ði¬m." )
	return 1;
end
