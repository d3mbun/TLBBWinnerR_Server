...
function x402293_UpdateEventList( sceneId, selfId, targetId )
	...
	if CallScriptFunction(402047, "IsCommonAGuild", sceneId, selfId ) == 1 then
		BeginEvent(sceneId);
			...
			AddNumText( sceneId, x402293_g_ScriptId, "Duy畉", 9, x402293_g_eventId_yes);
			AddNumText( sceneId, x402293_g_ScriptId, "H鼀", 8, x402293_g_eventId_no);
		EndEvent(sceneId);
