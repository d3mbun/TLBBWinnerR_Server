...
x808236_Impact ={29760,29776,29792,29808}

function x808236_OnImpactFadeOut( sceneId, selfId, impactId )
	if GetHp( sceneId, selfId ) == 0 then
		return
	end
	local nId = x808236_XinFaAddition( sceneId, selfId )
	local i=random(1,4)
	local targetId = LuaFnGetTargetObjID(sceneId, selfId)
	LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, targetId, x808236_Impact[i]+nId, 0 )
end
