...
function x122001_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "  A Di Ğà Ph§t, thi®n tai thi®n tai.#r  T¤t cä ğ«u tr· thành Ph§t pháp, ğ«u tr· thành bong bóng mµng äo mà thôi.#r  Nhß sß½ng cûng nhß ği®n, cûng chï ğ¬ nhìn nhß thª mà thôi.#r  Nhæng n½i $N ğã t×ng ği, ğ«u là hß äo cä, không b¢ng ğ¬ lão tång chï giáo cho ngß½i th¤y" )
...
function x122001_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if IsHaveMission(sceneId,selfId,4021) > 0 then
		x122001_MsgBox( sceneId, selfId, targetId, "  Các hÕ có nhi®m vø ch· hàng b¢ng ğß¶ng thuÖ, d¸ch trÕm chúng ta không th¬ cung c¤p d¸ch vø cho ngß½i" )
		return
	end
