...
function x020003_UpdateEventList( sceneId, selfId,targetId )
	...
	elseif IsStepDone1 == 0 and IsStepDone2 == 0 and IsStepDone3 == 0 then
		AddText(sceneId,"  Ngß½i chính là "..PlayerName.."?#r  Ca ca t× #G NhÕn B¡c#W gØi thß t¾i nói ngß½i là 1 anh hùng, kêu ta tiªp ðãi tØ tª. Nhßng ta th¤y ngß½i không gi¯ng 1 anh hùng")
