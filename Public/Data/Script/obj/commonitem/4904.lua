...
--脚本号
x334904_g_scriptId = 334904 --临时写这个,真正用的时候一定要改.
...
--AE的目标关系标记
x334904_g_standFlag = 1 -- 2:队友， 1：友军， -1：敌军
--AE影响数目限制
x334904_g_effectCount = 4 -- -1:不限制
--效果的ID
x334904_g_Impact1 = 4904 --临时写这个
x334904_g_Impact2 = -1 --不用
...
function x334904_OnDeplete( sceneId, selfId )
	...
	if(LuaFnDepletingUsedItem(sceneId, selfId)) then
		...
		if itmId > 0 then
			...
			local	str	= format( "#B#{_INFOUSR"..namSelf.."}#cff0000 痦ch th鈔 餰m #W["..namItem.."]#cff0000 mang 皙n #B#{_INFOUSR"..namTarget.."}#cff0000, 稹m 饀痠 nh靚 #B#{_INFOUSR"..namTarget.."}#cff0000." )
