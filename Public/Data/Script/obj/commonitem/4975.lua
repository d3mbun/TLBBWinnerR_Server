...
--½Å±¾ºÅ
 x334975_g_scriptId = 334975 --ÁÙÊ±Ð´Õâ¸ö,ÕæÕýÓÃµÄÊ±ºòÒ»¶¨Òª¸Ä.
...
--4948									437	ÆïÊõ£ºÖ©Öë
--4952									438	ÆïÊõ£ºÐÜ
--4975									439	ÆïÊõ£ºÄ¾Å£Á÷Âí
--4950									440	ÆïÊõ£ºÂ½Îá
--4949									441	ÆïÊõ£ºÐþ¹ê
--4946									442	ÆïÊõ£ºÏ¬Å£

--×¢£ºÁ½¸öÆïÊõ»áÒ»¸ö¾Í¿ÉÒÔÆïÁË
 x334975_g_Equitation1 = 437 --ÐèÒªµÄÆïÊõ
 x334975_g_Equitation2 = -1 --ÐèÒªµÄÆïÊõ
--Ð§¹ûµÄID
 x334975_g_Impact1 = 4975 --ÁÙÊ±Ð´Õâ¸ö
 x334975_g_Impact2 = -1 --²»ÓÃ

--**********************************
--ÊÂ¼þ½»»¥Èë¿Ú
--**********************************
function  x334975_OnDefaultEvent( sceneId, selfId, bagIndex )
...
--**********************************
function  x334975_IsSkillLikeScript( sceneId, selfId)
...
--**********************************
function  x334975_CancelImpacts( sceneId, selfId )
	nRet = 0;
	nRet = LuaFnCancelSpecificImpact(sceneId, selfId,  x334975_g_Impact1)
	if(0<nRet) then
		return 1;
	end
	return 0;
...
--**********************************
function  x334975_OnConditionCheck( sceneId, selfId )
	--Ð£ÑéÊ¹ÓÃµÄÎïÆ·
	--if(1~=LuaFnVerifyUsedItem(sceneId, selfId)) then
		--return 0
	--end
	--Á½¸öÆïÊõ£¬»áÒ»¸ö¾Í¿ÉÒÔÁË
	if(-1~= x334975_g_Equitation1) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x334975_g_Equitation1)) then
			return 1
		end
	end
	if(-1~= x334975_g_Equitation2) then
		if(1==LuaFnHaveSpecificEquitation(sceneId, selfId,  x334975_g_Equitation2)) then
			return 1
		end
	end
...
--**********************************
function  x334975_OnDeplete( sceneId, selfId )
	return 1; --Æï³Ë²»ÏûºÄ
end
...
--**********************************
function  x334975_OnActivateOnce( sceneId, selfId )
	if(-1~= x334975_g_Impact1) then
		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId,  x334975_g_Impact1, 0)
	end
...
--×¢£ºÕâÀïÊÇ¼¼ÄÜÉúÐ§Ò»´ÎµÄÈë¿Ú
--**********************************
function  x334975_OnActivateEachTick( sceneId, selfId)
