...
--½Å±¾ºÅ
 x335023_g_scriptId = 335023 --ÁÙÊ±Ð´Õâ¸ö,ÕæÕýÓÃµÄÊ±ºòÒ»¶¨Òª¸Ä.
...
--×¢£ºÁ½¸öÆïÊõ»áÒ»¸ö¾Í¿ÉÒÔÆïÁË
 x335023_g_Equitation1 = 1077 --ÐèÒªµÄÆïÊõ
 x335023_g_Equitation2 = -1 --ÐèÒªµÄÆïÊõ
--Ð§¹ûµÄID
 x335023_g_Impact1 = 5028 --ÁÙÊ±Ð´Õâ¸ö
 x335023_g_Impact2 = -1 --²»ÓÃ
