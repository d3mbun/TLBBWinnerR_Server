...
x002016_g_BoundRewardsId = 10155001		-- ·É»ÈÊ¯--[tx43452_]
...
function x002016_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if num == 1 then										-- ¶ÎÑÓÇìÈÎÎñ
		if IsHaveMission( sceneId, selfId, x002016_g_RSMissionId ) > 0 then
			x002016_NotifyFailBox( sceneId, selfId, targetId, "    Các hÕ còn có nhi®m vø quan h® v¾i các anh hùng (Nhi®m Vø k¸ch tình tu¥n hoàn) chßa hoàn thành, sau khi hoàn thành hãy ðªn tìm ta." )
			return
		end
		...
		--¿´ÏÂ½ñÌìµÄ¶ÎÑÓÇìÈÎÎñÊÇ²»ÊÇ×öÍê50´ÎÁË
