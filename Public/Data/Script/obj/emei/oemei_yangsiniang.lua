...
function x015010_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		if	GetLevel( sceneId, selfId)>=10  then	
			...
			AddNumText( sceneId, x015010_g_ScriptId, "Tô Châu - Thiªt Tßþng Ph¯", 9, 4 )
		end
		...
		AddNumText(sceneId,x015010_g_ScriptId,"Dçn ta t¾i các môn phái khác",9,11)

		-- ÎÒÔõÑù²ÅÄÜÈ¥¶Ø»ÍºÍáÔÉ½
		AddNumText( sceneId, x015010_g_ScriptId, "Ðªn Ðôn Hoàng và Tung S½n?", 11, 2000 )
