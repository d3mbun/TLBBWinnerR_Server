...
function x402041_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		if nSceneId == 0  then
			AddNumText( sceneId, x402041_g_scriptId, "Tr· v« LÕc Dß½ng", 9, 10 )
		elseif nSceneId == 1  then
			AddNumText( sceneId, x402041_g_scriptId, "Tr· v« Tô Châu", 9, 11 )
		elseif nSceneId == 2  then
			AddNumText( sceneId, x402041_g_scriptId, "Tr· v« ÐÕi Lí", 9, 12 )
		end
