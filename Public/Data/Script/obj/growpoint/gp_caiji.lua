...
-- mainId: Ö÷Òªµô³öÎï mExtraCountOdds: Ö÷Òªµô³öÎï¶îÍâµô³öÊýÁ¿µÄ¼¸ÂÊ
-- associatedId: ¸±²úÆ·ÁÐ±í£¬aOdds ¼¸ÂÊ³öÏÖÊ±Ëæ»ú³öÒ»¸ö£¬ÁÐ±í¿ÉÒÔÎª¿Õ aOdds: ¸±²úÆ·µô³öÂÊ aExtraCountOdds: ³öÏÖ¸±²úÆ·ºó¶îÍâÊýÁ¿¼¸ÂÊ
-- rareId: Ï¡ÓÐÎïÆ·£¬Ï¡ÓÐÎïÆ·¿ÉÒÔÃ»ÓÐ£¬Ìî -1£¬ rOdds: Ï¡ÓÐÎïÆ·µô³öÂÊ
-- needLevel: ²É¼¯´ËÉú³¤µãÐèÒªµÄ¼¶±ð

-- ÒÔÏÂ²¿·ÖÎª¿óÊ¯
x710000_g_GPInfo[1 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö ð°ng",
	mainId = 20103001, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },	-- ±íÃ÷ 100% ¼¸ÂÊµôÂä£¬50% ¼¸ÂÊµô2¸ö£¬38% ¼¸ÂÊµôÈý¸ö£¬10% ¼¸ÂÊµôËÄ¸ö£¬1% ¼¸ÂÊµôÎå¸ö£¬1% ¼¸ÂÊµôÁù¸ö£¬
...
x710000_g_GPInfo[2 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö s¡t",
...
x710000_g_GPInfo[3 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö bÕc",
...
x710000_g_GPInfo[4 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö hàn thiªt",
...
x710000_g_GPInfo[5 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö vàng",
...
x710000_g_GPInfo[6 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö huy«n thiªt",
...
x710000_g_GPInfo[7 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö pha lê",
...
x710000_g_GPInfo[8 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö phï thúy",
...
x710000_g_GPInfo[9 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö Chân Vû",
...
x710000_g_GPInfo[10] = { abilityId = ABILITY_CAIKUANG, name = "Mö Long Huyªt",
...
x710000_g_GPInfo[11] = { abilityId = ABILITY_CAIKUANG, name = "Mö Phøng Huyªt",
...
x710000_g_GPInfo[12] = { abilityId = ABILITY_CAIKUANG, name = "Næ Oa ThÕch",
...
x710000_g_GPInfo[13] = { abilityId = ABILITY_CAIKUANG, name = "Côn s½n khoáng ng÷c",
	...
	rareId = -1, rOdds = 100, needLevel = 9 }
x710000_g_GPInfo[14] = { abilityId = ABILITY_CAIKUANG, name = "Chúng sinh khoáng thÕch",
...
-- ÒÔÏÂ²¿·ÖÎª²ÝÒ©
x710000_g_GPInfo[101] = { abilityId = ABILITY_CAIYAO, name = "BÕch Anh",
	...
	rareId = -1, rOdds = 100, needLevel = 1 }
x710000_g_GPInfo[102] = { abilityId = ABILITY_CAIYAO, name = "B° Hoàng",
	mainId = 20101002, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304005 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 1 }
x710000_g_GPInfo[103] = { abilityId = ABILITY_CAIYAO, name = "Xuyên B¯i",
	...
	rareId = -1, rOdds = 100, needLevel = 2 }
x710000_g_GPInfo[104] = { abilityId = ABILITY_CAIYAO, name = "Nguyên H°",
	mainId = 20101004, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304006 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 2 }
x710000_g_GPInfo[105] = { abilityId = ABILITY_CAIYAO, name = "TÏ Bà",
	mainId = 20101005, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304006 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 3 }
x710000_g_GPInfo[106] = { abilityId = ABILITY_CAIYAO, name = "Cam Thäo",
	...
	rareId = -1, rOdds = 100, needLevel = 3 }
x710000_g_GPInfo[107] = { abilityId = ABILITY_CAIYAO, name = "Kim Ngân Hoa",
	mainId = 20101007, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304007 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 3 }
x710000_g_GPInfo[108] = { abilityId = ABILITY_CAIYAO, name = "Hoàng C¥m",
	mainId = 20101008, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304007 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 4 }
x710000_g_GPInfo[109] = { abilityId = ABILITY_CAIYAO, name = "C¦u KÖ",
	...
	rareId = -1, rOdds = 100, needLevel = 4 }
x710000_g_GPInfo[110] = { abilityId = ABILITY_CAIYAO, name = "Tr¥m Hß½ng",
	mainId = 20101010, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304008 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 4 }
x710000_g_GPInfo[111] = { abilityId = ABILITY_CAIYAO, name = "Ð² Tr÷ng",
	mainId = 20101011, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304008 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 5 }
x710000_g_GPInfo[112] = { abilityId = ABILITY_CAIYAO, name = "Thß½ng Thu§t",
	...
	rareId = -1, rOdds = 100, needLevel = 5 }
x710000_g_GPInfo[113] = { abilityId = ABILITY_CAIYAO, name = "Phøc Linh",
	mainId = 20101013, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304009 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 5 }
x710000_g_GPInfo[114] = { abilityId = ABILITY_CAIYAO, name = "Phòng Phong",
	mainId = 20101014, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304009 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 6 }
x710000_g_GPInfo[115] = { abilityId = ABILITY_CAIYAO, name = "Hß½ng Nhu",
	...
	rareId = -1, rOdds = 100, needLevel = 6 }
x710000_g_GPInfo[116] = { abilityId = ABILITY_CAIYAO, name = "Hoàng Liên",
	mainId = 20101016, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304010 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 6 }
x710000_g_GPInfo[117] = { abilityId = ABILITY_CAIYAO, name = "Ðß½ng Qui",
	mainId = 20101017, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304010 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 7 }
x710000_g_GPInfo[118] = { abilityId = ABILITY_CAIYAO, name = "Quª Tâm",
	...
	rareId = -1, rOdds = 100, needLevel = 7 }
x710000_g_GPInfo[119] = { abilityId = ABILITY_CAIYAO, name = "Hß½ng Phø",
	mainId = 20101019, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304011 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 7 }
x710000_g_GPInfo[120] = { abilityId = ABILITY_CAIYAO, name = "Ho¡c Hß½ng",
	mainId = 20101020, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304011 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 8 }
x710000_g_GPInfo[121] = { abilityId = ABILITY_CAIYAO, name = "H°i Th¥n Thäo",
	...
	rareId = -1, rOdds = 100, needLevel = 8 }
x710000_g_GPInfo[122] = { abilityId = ABILITY_CAIYAO, name = "Thü Ô",
	mainId = 20101022, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304012 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 8 }
x710000_g_GPInfo[123] = { abilityId = ABILITY_CAIYAO, name = "Ðông Trùng HÕ Thäo",
	...
	rareId = -1, rOdds = 100, needLevel = 9 }
x710000_g_GPInfo[124] = { abilityId = ABILITY_CAIYAO, name = "Long Quì TØ",
	...
	rareId = -1, rOdds = 100, needLevel = 9 }
x710000_g_GPInfo[125] = { abilityId = ABILITY_CAIYAO, name = "Tßþng B¯i",
	...
	rareId = -1, rOdds = 100, needLevel = 10 }
x710000_g_GPInfo[126] = { abilityId = ABILITY_CAIYAO, name = "Nhân Sâm",
...
x710000_g_GPInfo[127] = { abilityId = ABILITY_CAIYAO, name = "Linh Chi",
	...
	rareId = -1, rOdds = 100, needLevel = 11 }
x710000_g_GPInfo[128] = { abilityId = ABILITY_CAIYAO, name = "Tuân Thäo",
	...
	rareId = -1, rOdds = 100, needLevel = 11 }
x710000_g_GPInfo[129] = { abilityId = ABILITY_CAIYAO, name = "Liên TØ",
	mainId = 20101029, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },
	associatedId = { 20304015 }, aOdds = 2500, aExtraCountOdds = { 9000, 4000, 2000, 1000 },
	rareId = -1, rOdds = 100, needLevel = 12 }
x710000_g_GPInfo[130] = { abilityId = ABILITY_CAIYAO, name = "Khô Mµc Xuân",
...
x710000_g_abilityName[ABILITY_CAIKUANG] = "Khai khoáng"
x710000_g_abilityName[ABILITY_CAIYAO] = "Hái dßþc"
...
function x710000_OnCreate( sceneId, growPointType, x, y )
	...
	-- Ã¿¸öÉú³¤µã×îÉÙÄÜµÃµ½Ò»¸öÎïÆ·£¬ÕâÀïÖ±½Ó·ÅÈë itembox ÖÐÒ»¸ö
...
function x710000_OnOpen( sceneId, selfId, targetId )
	...
	if AbilityLevel < GPInfo.needLevel then
		x710000_NotifyFailTips( sceneId, selfId,
			"C¥n " .. x710000_g_abilityName[GPInfo.abilityId] .. " kÛ nång " .. GPInfo.needLevel .. ", hi®n các hÕ ðang ðÕt " .. AbilityLevel .. "  c¤p" )
		return OR_NO_LEVEL
	end
