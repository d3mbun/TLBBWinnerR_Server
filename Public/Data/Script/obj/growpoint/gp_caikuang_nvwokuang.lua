...
--女娲石矿
--脚本号710001
--女娲石1	0.6		2	0.3		3	0.1		虎眼石1%
--以20%概率得到副产品20103024,20103036,20103048,20103060 中的一种，数量1	0.6		2	0.3		3	0.1
--等级1
...
function x710012_OnCreate(sceneId,growPointType,x,y)
	--放入ItemBox同时放入一个物品
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710012_g_MainItemId)	--每个生长点最少能得到一个物品,这里直接放入itembox中一个
