...
--铜矿
--脚本号710001
--铜矿石1	0.6		2	0.3		3	0.1		黑宝石1%
--以20%概率得到副产品20103013,20103025,20103037,20103049 中的一种，数量1	0.6		2	0.3		3	0.1
--等级1
...
function x710001_OnCreate(sceneId,growPointType,x,y)
	--放入ItemBox同时放入一个物品
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710001_g_MainItemId)	--每个生长点最少能得到一个物品,这里直接放入itembox中一个
