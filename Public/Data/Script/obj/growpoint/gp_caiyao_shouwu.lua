...
--首乌
--脚本号710521
--首乌1	0.6		2	0.3		3	0.1		金环蛇出现的概率是0.2		数量1	0.6		2	0.3		3	0.1
--等级1
...
function x710521_OnCreate(sceneId,growPointType,x,y)
	--放入ItemBox同时放入一个物品
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710521_g_MainItemId)	--每个生长点最少能得到一个物品,这里直接放入itembox中一个
