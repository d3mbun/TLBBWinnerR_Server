...
-- rareId: Ï¡ÓĞÆ·µÄÎïÆ·ºÅ£¬Èç¹ûÃ»ÓĞÔòÌî -1
-- rOdds: Ï¡ÓĞÆ·µÄ³öÏÖ¼¸ÂÊ£¬random( x711001_g_RandNum ) <= rOdds Ê±Ï¡ÓĞÎïÆ·²úÉú£¬x711001_g_RandNum ¿ÉÒÔ¸ù¾İÊµ¼ÊÇé¿ö¸ü¸Ä
...
--	end
	...
	--ÅĞ¶ÏÖÖÖ²ÅÆÊÇ·ñÊÇ8£¬Èç¹ûÊÇ8ÔòÍ¨ÖªÍæ¼Ò
	if PLANTFLAG[num] == 8 then
		local strMail = format("Thñc v§t do các hÕ tr°ng ğã chín t¾i, trong vòng %d phút hãy ğªn #G%s(%d,%d)#W thu hoÕch.",
