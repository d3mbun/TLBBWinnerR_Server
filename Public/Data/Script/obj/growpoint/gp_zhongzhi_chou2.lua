...
--ÏÂÒ»¸öÉú³¤µãµÄ±àºÅ
x711043_g_GpIdNext = 545

function	 x711043_OnRecycle(sceneId,selfId,targetId)
	itemBoxX = GetItemBoxWorldPosX(sceneId,targetId)
	itemBoxZ = GetItemBoxWorldPosZ(sceneId,targetId)
	ItemBoxId = ItemBoxEnterScene(itemBoxX,itemBoxZ,x711043_g_GpIdNext,sceneId,QUALITY_MUST_BE_CHANGE,1,20105003)
