...
x009036_g_mpInfo		= {}
x009036_g_mpInfo[0]	= { "Tinh Túc", 16,  96, 152, MP_XINGSU }
x009036_g_mpInfo[1]	= { "Tiêu Dao", 14,  67, 145, MP_XIAOYAO }
x009036_g_mpInfo[2]	= { "Thiªu Lâm",  9,  95, 137, MP_SHAOLIN }
x009036_g_mpInfo[3]	= { "Thiên S½n", 17,  95, 120, MP_TIANSHAN }
x009036_g_mpInfo[4]	= { "Thiên Long", 13,  96, 120, MP_DALI }
x009036_g_mpInfo[5]	= { "Nga My", 15,  89, 144, MP_EMEI }
x009036_g_mpInfo[6]	= { "Võ Ðang", 12, 103, 140, MP_WUDANG }
x009036_g_mpInfo[7]	= { "Minh Giáo", 11,  98, 167, MP_MINGJIAO }
x009036_g_mpInfo[8]	= { "Cái Bang", 10,  91, 116, MP_GAIBANG }
x009036_g_mpInfo[9]	= { "Mµ Dung", 195,  29, 137, MP_GUSU }
x009036_g_mpInfo[10]= { "Ðß¶ng Môn", 521,  125, 65, MP_TANGMEN }
x009036_g_mpInfo[11]= { "QuÖ C¯c", 589,  85, 150, MP_GUIGU }
...
function x009036_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		if	GetLevel( sceneId, selfId)>=10  then	
			AddNumText(sceneId,x009036_g_ScriptId,"LÕc Dß½ng",9,0)
			AddNumText(sceneId,x009036_g_ScriptId,"Tô Châu",9,1)
			AddNumText( sceneId, x009036_g_ScriptId, "LÕc Dß½ng - CØu Châu thß½ng hµi", 9, 3 )
			AddNumText( sceneId, x009036_g_ScriptId, "Tô Châu - Thiªt Tßþng Ph¯", 9, 4 )
		end
		
		--add by WTT
		if	GetLevel( sceneId, selfId)>=20  then	
			AddNumText( sceneId, x009036_g_ScriptId, "Thúc Hà C± Tr¤n", 9, 6 )
		end
		...
		AddNumText(sceneId,x009036_g_ScriptId,"ÐÕi Lý",9,2)
		
		--[tx42913]
		   CallScriptFunction( x009036_g_xuanWuDaoId, "OnEnumerate",sceneId, selfId, targetId )
		--[/tx42913]		
		
		AddNumText(sceneId,x009036_g_ScriptId,"Dçn ta t¾i các môn phái khác",9,11)
...
--[tx42913]
	if eventId == x009036_g_xuanWuDaoId then --È¥ÐþÎäµº
    ...
    if  GetNumText() == 11 then
		...
		BeginEvent(sceneId)
		    ...
		    for i=0, getn(x009036_g_mpInfo) do
				AddNumText( sceneId, x009036_g_ScriptId, "Môn phái - "..x009036_g_mpInfo[i][1], 9, i+12 )
			end			
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)	
		return 
