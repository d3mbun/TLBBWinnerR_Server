...
function x001119_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001119_g_scriptId, "Gi¾i thi®u v« kªt hþp nguyên li®u", 11, 20 ) -- add by cuiyinjie 20081021
		AddNumText( sceneId, x001119_g_scriptId, "Bäo ThÕch Hþp Thành", 6, 1 )
		AddNumText( sceneId, x001119_g_scriptId, "Ðøc L² Trang B¸", 6, 2 )
		...
		AddNumText( sceneId, x001119_g_scriptId, "Khäm Bäo ThÕch", 6, 5 )
		AddNumText( sceneId, x001119_g_scriptId, "Ðiêu Trách Bäo ThÕch", 6, 6 )
		AddNumText( sceneId, x001119_g_scriptId, "Bäo ThÕch Dung Luy®n", 6, 7 )
...
function x001119_OnEventRequest( sceneId, selfId, targetId, eventId )
		...
		if GetNumText() == 0 then
			BeginEvent(sceneId)	
				...
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u hþp thành Bäo ThÕch",11,9);
...
--				AddNumText(sceneId, x001119_g_scriptId,"×°±¸ÐÞÀí½éÉÜ",11,12);
				...
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u v« Bäo ThÕch Dung Luy®n",11,14);
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u v« Th¡ng lþi Bäo ThÕch",11,15);
		...
		if GetNumText() == 20 then  -- add by cuiyinjie ²ÄÁÏºÏ³É½éÉÜ
			BeginEvent(sceneId)			
				...
				AddNumText(sceneId, x001119_g_scriptId,"Gi¾i thi®u v« thao tác Miên B¯",11,23);					
			EndEvent(sceneId)
			DispatchEventList(sceneId,selfId,targetId)
			return
		end
