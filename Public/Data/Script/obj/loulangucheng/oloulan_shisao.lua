...
--NPC¶Ô°×
--**********************************
		AddNumText( sceneId, x001157_g_scriptId, "Mua Bµ Chiªn Th¥n Ph¯i Phß½ng", 7, 0 )
...
function x001157_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if GetNumText() == 1 then
		BeginEvent(sceneId)						
			...
			AddNumText(sceneId, x001157_g_scriptId, "Duy®t", 8, 3 )
			AddNumText(sceneId, x001157_g_scriptId, "Hüy", 8, 4 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
		return
	end
	...
	if GetNumText() == 2 then
		BeginEvent(sceneId)						
			...
			AddNumText(sceneId, x001157_g_scriptId, "Duy®t", 8, 5 )
			AddNumText(sceneId, x001157_g_scriptId, "Hüy", 8, 4 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
		return
