...
--龟兔赛跑任务完成标记
x311007_g_Mission_IsComplete = 0	--任务参数的第0位
--龟兔赛跑洛阳打卡标记
x311007_g_LuoYang_RecordIdx = 1		--任务参数的第1位
--龟兔赛跑苏州打卡标记
x311007_g_SuZhou_RecordIdx = 2		--任务参数的第2位
--龟兔赛跑大理打卡标记
x311007_g_DaLi_RecordIdx = 3			--任务参数的第3位
--孔明灯完成数量标记
x311007_g_KongMing_Lighten = 4		--任务参数的第4位
--龟兔赛跑传递任务每天轮数标记
x311007_g_RoundIndex = 7					--任务参数的第7位
...
function x311007_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		if x311007_OnIsFillPlayCard(sceneId, selfId, targetId) == 1 then
			...
			AddNumText( sceneId, x311007_g_scriptId, "T靘 hi瑄 T鄌 v", 11, 1 )
			AddNumText( sceneId, x311007_g_scriptId, "B 馥u T鄌 v", 7, 2 )
