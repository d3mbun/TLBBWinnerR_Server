...
--龟兔赛跑任务完成标记
x311008_g_Mission_IsComplete = 0	--任务参数的第0位
--龟兔赛跑洛阳打卡标记
x311008_g_LuoYang_RecordIdx = 1		--任务参数的第1位
--龟兔赛跑苏州打卡标记
x311008_g_SuZhou_RecordIdx = 2		--任务参数的第2位
--龟兔赛跑大理打卡标记
x311008_g_DaLi_RecordIdx = 3			--任务参数的第3位
--孔明灯完成数量标记
x311008_g_KongMing_Lighten = 4		--任务参数的第4位
--龟兔赛跑任务每天轮数标记
x311008_g_RoundIndex = 7					--任务参数的第7位
