...
x400956_g_name	="Xa Thuy«n Nghîa";

--´«ËÍÄ¿±ê
x400956_g_transfer_target =
{
	[1] = {x = 235, z = 156, scene_num = 1}, 		--Tô Châu
	[2] = {x = 246, z = 106, scene_num = 2}, 		--ÐÕi Lý
	[3] = {x = 294, z = 90, scene_num = 186}, 	--Lâu Lan
...
function x400956_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if id >=1 and id <= 6 then
		BeginEvent(sceneId)
			...
			AddNumText(sceneId, x400956_g_ScriptId, "Hüy", 0, 100);
		EndEvent()
		DispatchEventList(sceneId, selfId, targetId);
	elseif id == 100 then
		...
		--[tx44121]bugÕâÀïÃ»ÓÐÉèÖÃ×îµÍc¤p±ð,µ¼ÖÂµÍc¤p±ð¿ÉÍ¨¹ýË«Æï³Ë½ø¸ßc¤p±ð³¡¾°
		local minLevel = 10
		if index == 3 then
			minLevel = 75
		end
