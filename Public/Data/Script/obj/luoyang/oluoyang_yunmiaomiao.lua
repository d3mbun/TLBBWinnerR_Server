...
--ËùÓµÓÐµÄÊÂ¼þIDÁÐ±í
x000101_g_eventList={800107,311112,311113}  --ÕäÊÞ¼¼ÄÜÉý¼¶
...
function x000101_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText(sceneId,x000101_g_scriptId,"Hoàn ð°ng",6,2)
		...
		--AddNumText(sceneId,x000101_g_scriptId,"Ðång tin Trân Thú",6,5)
		--AddNumText(sceneId,x000101_g_scriptId,"Trân thú Giao Hæu",6,6)
		--AddNumText(sceneId,x000101_g_scriptId,"Sinh sän",6,7)
