...
-- ñÒÉÙÎ¢£¬2008.5.29¡£¼«Æ·×°±¸·Å³ö¡£Á½¸ö¶Ò»»ÐèÒªµÄÎïÆ·£º20310101--ÖØÂ¥Ö®Àá	20310102--ÖØÂ¥Ö®Ã¢
...
function x001067_OnMissionSubmit( sceneId, selfId, targetId, missionScriptId, selectRadioId )
	...
	if x001067_g_EquipList[nItemIndex].n == 9100 then
		if selectRadioId == 10309106 then
			nLevel = 9
		else 
			if selectRadioId == 10309112 then
				nLevel = 10
			end
		end
	end
